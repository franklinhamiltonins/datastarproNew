...
Route::any('/check-max-execution-time/{contactId}', 'ChatController@checkMaxExecutionTime')->name('chat.checkMaxExecutionTime');
...
Route::any('/import_scrap', 'BotController@importScrap')->name('importScrap');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    // leads actions
    Route::post('/leads/actions/{id}', 'Leads\ActionController@addAction')->name('leads.actions');
    Route::get('/actions/leads-contact-report', 'Leads\ActionController@index')->name('actions.index');
    // route for leade report datatables
    Route::post('/actions/datatable', 'Leads\ActionController@getContactReport')->name('actions.getContactReport');
    ...
    Route::post('/marketing-campaigns-table', 'CampaignController@campaignsTable')->name('campaigns.campaignsTable');
