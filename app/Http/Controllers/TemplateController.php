    ...
    public function edit($id)
    {
        ...
        if ($template->created_by == auth()->user()->id) {
            ...
            if ($is_admin) {
                ...
                foreach ($selected_agents_arr as $selected_agent) {
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($userIds) {
            ...
            if (! empty($agents_to_remove)) {
                UserTemplate::where('template_id', $id)->whereIn('user_id', $agents_to_remove)->delete();
            }
            ...
            if (! empty($selected_agents)) {
                UserTemplate::where('template_id', $id)->whereIn('user_id', $selected_agents)->delete();
            }
        }
