...
class DialingController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $leadsQuery = $this->leadOutputGetFordialing($location_leads_id_search, $location_leads_id, $search_fields, $campaignId);
    ...
    public function show(Request $request, $encoded_id)
    {
        ...
        return view('dialings.show', compact($vars, 'agentUsers', 'dialing', 'is_admin'));
    }
