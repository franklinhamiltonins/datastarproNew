<div class="d-flex justify-content-center action-btns">
    ...
    @if ($row->created_by == auth()->user()->id)
        <a
            ...
            href="{{ route("templates.edit", base64_encode($row->id)) }}"
            {{ $row->created_by == auth()->user()->id ? "" : "disabled" }}
        >
    ...
    @else
        <a
            class="btn btn-sm btn-success action-btn m-0 d-flex justify-content-center align-items-center disabled"
            href="#"
        >
            <i class="fa fa-edit"></i>
        </a>
