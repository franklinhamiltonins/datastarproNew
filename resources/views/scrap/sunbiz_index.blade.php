                        ...
                        <div class="row">
                            <div class="col-lg-12 margin-tb d-flex flex-wrap justify-content-between table-top-sec">
                                <div class="d-flex flex-wrap align-items-center">
                                    ...
                                    <div
                                        class="custom_search_page d-flex align-items-center justify-content-between ml-1"
                                    >
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            ...
            jQuery(document).on('click', '.submit_business_button', function () {
                ...
                var prev_lead_name = jQuery('#businessName_' + lead_id)
                    .text()
                    .trim();
                ...
                jQuery.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.status == 'error') {
                            ...
                            $(`#businessName_${lead_id}`)
                                .html(
                                    `<a href="${window.location.origin}/leads/edit/${encryptedId}" target="_blank">${lead_name}</a>`,
                                )
                                .show();
        ...
        function draw_table() {
            ...
            jQuery('#contact_scrap_datatable').on('change', '.select-all', function () {
                ...
                if (checked) {
                    var selectedValues = jQuery('.select-row:checked')
                        .map(function () {
                            return this.value;
                        })
                        .get();
