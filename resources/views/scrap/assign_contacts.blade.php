        ...
        <div class="container-fluid">
            <table class="assign-table mb-4 table table-bordered bg-white">
                <tr class="assign-tr bg-gray">
                    <th class="assign-th p-2">
                        <input type="checkbox" name="select_all_assign" value="" class="select_all_assign" />
                    </th>
                ...
                @foreach ($contacts as $contact)
                    <tr class="assign-tr">
                        <td class="assign-td bg-gray-light p-2">
                            <input
                                type="checkbox"
                                name="contacts_checkbox"
                                value="{{ $contact->id }}"
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#sendDataBtn').click(function () {
                var selectedValues = $('.column-checkbox:checked')
                    .map(function () {
