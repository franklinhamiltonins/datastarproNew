        ...
        <div class="modal-content">
            <div class="modal-body text-center p-2 p-lg-3">
                ...
                <div class="d-flex flex-column">
                    <button type="button" id="confirmDelete" class="btn btn-outline-light bg-danger py-2 mb-2">
                        Yes, Delete
                    </button>
                    <button
                        type="button"
                        class="btn btn-outline-light border-danger text-danger"
