            ...
            <form id="loginForm" class="pb-4">
                ...
                <div id="step1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <button id="step1Submit" type="submit" class="btn btn-primary btn-block btn-flat">
                                Sign In
                            </button>
                        </div>
                    </div>
                ...
                <div id="step2" style="display: none">
                    ...
                    <div class="d-flex gap-3 align-items-center">
                        <button
                            id="verifyOtpBtn"
                            type="button"
                            class="btn btn-primary d-flex align-items-center justify-content-center flex-fill"
                        >
                        ...
                        <button
                            id="resendOtpBtn"
                            type="button"
                            class="p-0 border-0 text-primary bg-transparent flex-fill text-decoration-underline outline-none"
                        >
                            Resend Code
                        </button>
                    </div>
                    <div class="showLeftAttemt displayNoneClass">
                        <p class="text-sm text-center mb-0 mt-3">
                            You have
                            <span id="leftAttempt"></span>
                            remaining attempts out of
                            <span id="totalAttempt"></span>
                            .
                        </p>
                    </div>
                </div>
    ...
    <script>
        ...
        $(function () {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        if (res.status) {
                            ...
                            $('#server-message').html(
                                '<div class="text-center alert alert-danger">' + res.message + '</div>',
                            );
                        }
                    },
                    error: function (xhr) {
            ...
            $('#verifyOtpBtn').on('click', function (e) {
                ...
                if ($('#otp').val() == '') {
                    $('#server-message').html(
                        '<div class="text-center alert alert-danger">Please Enter 2FA Code</div>',
                    );
                    return false;
                }
            ...
            $('#resendOtpBtn').on('click', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.status) {
                            $('#server-message').html(
                                '<div class="text-center alert alert-success">Code Resent Successfully.</div>',
                            );
