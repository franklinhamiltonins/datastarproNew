                    ...
                    <div class="pull-right">
                        @can("role-create")
                            <a class="btn btn-secondary btn-sm" href="{{ route("roles.create") }}">
                                ...
                                <span class="d-none d-md-inline">Create New Role</span>
                            </a>
                        @endcan
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a
                                        ...
                                        href="{{ route("roles.show", base64_encode($role->id)) }}"
                                        title="Show"
                                    >
                                        <i class="fa fa-eye"></i>
                                    </a>
                                    @if ($role->name != "Super Admin")
                                        @can("role-edit")
                                            <a
                                                ...
                                                href="{{ route("roles.edit", base64_encode($role->id)) }}"
                                                title="Edit"
                                            >
                                        ...
                                        @can("role-clone")
                                            <a
                                                ...
                                                href="{{ route("roles.edit", base64_encode($role->id)) }}?action=clone"
                                                title="Clone"
                                            >
