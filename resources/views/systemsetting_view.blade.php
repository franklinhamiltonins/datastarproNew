                    ...
                    <div class="bg-white rounded shadow-sm border">
                        ...
                        <div class="form-group p-3 mb-0">
                            <div class="row">
                                <div class="col-md-4">
                                    <label class="mb-1">
                                        Proceed Time In Minute
                                        <sup class="mandatoryClass">*</sup>
                                        :
                                    </label>
                                    <input
                                        placeholder="Proceed Time In Minute"
                                        class="form-control"
                                        name="proceed_time_in_minute"
                                        type="text"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <span class="notifySpan">
                                        You can save multiple email with csv format eg- "testxx.com,test2xx.com"
                                    </span>
                                </div>
                                <div class="col-md-4">
                                    <label class="mb-1">
                                        Proceed Time In Day Pipeline
                                        <sup class="mandatoryClass">*</sup>
                                        :
                                    </label>
                                    <input
                                        placeholder="Proceed Time In Day"
                                        class="form-control"
                                        name="process_time_in_day_pipeline"
                                        type="text"
                                ...
                                <div class="col-md-4">
                                    <label class="mb-1">
                                        Notify Email Pipeline
                                        <sup class="mandatoryClass">*</sup>
                                        :
                                    </label>
                                    <input
                                        placeholder="Notify Email Pipeline"
                                        class="form-control"
                                        name="notify_email_pipeline"
                                        type="text"
                                ...
                                <div class="col-md-4">
                                    <label class="mb-1">
                                        Renewal Notification In Day Pipeline
                                        <sup class="mandatoryClass">*</sup>
                                        :
                                    </label>
                                    <input
                                        placeholder="Renewal Notification In Day Pipeline"
                                        class="form-control"
                                        name="renewal_days_in_pipeline"
                                        type="text"
