                        ...
                        <div class="form-group p-3 mb-0">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input placeholder="Notify Email" class="form-control" name="notify_email"
                                        type="text"
                                        value="{{ isset($setting_time_data) && $setting_time_data->notify_email ? $setting_time_data->notify_email : '' }}">
                                    <span class="notifySpan">You can save multiple email with csv format eg-
                                        "testxx.com,test2xx.com"</span>
                                </div>
                                <div class="col-md-4">
                                    <label class="mb-1">Proceed Time In Day Pipeline<sup
                                            class="mandatoryClass">*</sup>:</label>
                                ...
                                <div class="col-md-4">
                                    <label class="mb-1">Renewal Notification In Day Pipeline<sup
                                            class="mandatoryClass">*</sup>:</label>
