            ...
            <div class="row">
                <div class="col-lg-12 mb-3">
                    <div class="pull-right">
                        <a class="btn btn-info btn-sm px-2 mb-3 mb-md-0" href="{{ route("platform_setting.index") }}">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card card-secondary">
                        ...
                        {!!
                            Form::model($scrapApi, ["method" => "POST", "route" => ["platform_setting.update", $scrapApi->id], "id" => "lead_update_form"])
                        !!}
