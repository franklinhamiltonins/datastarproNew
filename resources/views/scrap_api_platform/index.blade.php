                ...
                <div class="card-body p-0 pb-3">
                            ...
                            <div class="col-lg-12 margin-tb d-flex flex-wrap justify-content-between table-top-sec">
                                <div class="d-flex align-items-center flex-wrap action-dropdown pb-2">
                                    <div class="dropdown">
                                        ...
                                        <div
                                            class="dropdown-menu rounded-top-0 p-0 m-0 text-nowrap"
                                            aria-labelledby="actionbtn"
                                        >
                                            <a
                                                class="btn btn-sm rounded-0 btn-block btn-info"
                                                href="{{ route("platform_setting.scrap_contact_view") }}"
                                            >
                                    ...
                                    <div
                                        class="custom_search_page d-flex align-items-center justify-content-between ml-2"
                                    >
                                ...
                                <div class="d-flex flex-wrap pb-2">
                                    <div
                                        id="scrap_api_platforms_datatable_filter"
                                        class="dataTables_filter search-sec mb-0"
                                    >
                                        <label
                                            class="d-flex align-items-center justify-content-end mb-0 position-relative"
                                        >
                                            <input
                                                type="search"
                                                id="customSearchBox"
                                    ...
                                    <div class="ml-1 d-flex">
                                        <a
                                            ...
                                            href="{{ route("platform_setting.create") }}"
                    ...
                    <div class="px-3 pt-1">
                        <div class="table-container pb-2">
                            <table
                                class="row-border order-column compact hover searchHighlight scrap_api_platforms_datatable border-top"
                                id="scrap_api_platforms_datatable"
                            >
