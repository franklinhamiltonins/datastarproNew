...
<div class="modal" id="newdeleteModal" data-source="" style="display: none;">
	<div class="modal-dialog">
		<div class="modal-content border border-danger p-0">
			...
			<form id="carrierForm">
				<input type="hidden" name="previous_id" id="previous_carrier_id">
			...
			<div class="modal-footer p-2 p-lg-3 justify-content-between">
				<button type="button" id="close_delete_modal" class="btn btn-dark" data-dismiss="modal">No</button>
...
<script>
	$(document).on("click", "#confirmdelete", function () {
	    let formData = $("#carrierForm").serialize(); // Get all form data
	    
	    $.ajax({
	        url: "/carrier/carrierFormSubmission", // Replace with your API URL
	        method: "POST",
	        data: formData,
	        dataType: "json",
