    ...
    <div class="sidebar">
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can("lead-navigation")
                    <li
                        class="nav-item has-treeview {{ request()->routeIs("leads.*") || request()->routeIs("registeragent.*") || request()->routeIs("contacts.*") ? "menu-open" : "" }}"
                    >
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @can("register-agent-list")
                                <li class="nav-item">
                                    <a
                                        href="{{ route("registeragent.index") }}"
                    ...
                    >
                        ...
                        <ul class="nav nav-treeview">
                            @can("setting-document")
                                <li class="nav-item">
                                    <a
                                        href="{{ route("settings.doc") }}"
                                        class="nav-link {{ request()->routeIs("settings.doc") ? "active" : "" }}"
                                    >
                            ...
                            @can("setting-system")
                                <li class="nav-item">
                                    <a
                                        href="{{ route("settings.systemsetting") }}"
                                        class="nav-link {{ request()->routeIs("settings.systemsetting") ? "active" : "" }}"
                                    >
                            ...
                            @can("setting-contact-status")
                                <li class="nav-item">
                                    <a
                                        href="{{ route("contactstatus.index") }}"
                                        class="nav-link {{ request()->routeIs("contactstatus.index") ? "active" : "" }}"
                                    >
                            ...
                            @can("setting-carrier")
                                <li class="nav-item">
                                    <a
                                        ...
                                        class="nav-link {{ request()->routeIs("carrier.index") ? "active" : "" }}"
                                    >
                            ...
                            @can("setting-leadsource")
                                <li class="nav-item">
                                    <a
                                        ...
                                        class="nav-link {{ request()->routeIs("leadsource.index") ? "active" : "" }}"
                                    >
                            ...
                            @can("setting-smtp")
                                <li class="nav-item">
                                    <a
                                        href="{{ route("smtps.index") }}"
                                        class="nav-link {{ request()->routeIs("smtps.index") ? "active" : "" }}"
                                    >
                            ...
                            @can("setting-smsprovider")
                                <li class="nav-item">
                                    <a
                                        ...
                                        class="nav-link {{ request()->routeIs("smsprovider.index") ? "active" : "" }}"
                                    >
                            ...
                            @can("setting-template")
                                <li class="nav-item">
                                    <a
                                        ...
                                        class="nav-link {{ request()->routeIs("templates.index") ? "active" : "" }}"
                                    >
                            ...
                            @can("setting-scrapapi")
                                <li class="nav-item">
                                    <a
                                        href="{{ route("platform_setting.index") }}"
                                        class="nav-link {{ request()->routeIs("platform_setting.index") ? "active" : "" }}"
                                    >
                            ...
                            @can("setting-sunbiz")
                                <li class="nav-item">
                                    <a
                                        href="{{ route("scrap_sunbiz") }}"
                                        class="nav-link {{ request()->routeIs("scrap_sunbiz") ? "active" : "" }}"
                                    >
                                        <i class="fas fa-solid fa-cogs nav-icon"></i>
                                        <p>Sunbiz Scrap</p>
                                    </a>
                            ...
                            @can("setting-newsletter")
                                <li class="nav-item">
                                    <a
                                        ...
                                        class="nav-link {{ request()->routeIs("newsletter.index") ? "active" : "" }}"
                                    >
                ...
                @can("report-display")
                    <li
                        class="nav-item has-treeview {{ request()->routeIs("agentreport.activityReport") || request()->routeIs("agentreport.mailerLeadReport") || request()->routeIs("agentreport.daillyCallReport") ? "menu-open" : "" }}"
                    >
                        <a href="#" class="nav-link">
                            <i class="fas fa-file-alt nav-icon"></i>
                            <p>
                        ...
                        <ul class="nav nav-treeview">
                            @can("report-activity-result")
                                <li class="nav-item">
                                    <a
                                        href="{{ route("agentreport.activityReport") }}"
                                        class="nav-link {{ request()->routeIs("agentreport.activityReport") ? "active" : "" }}"
                                    >
                                        <i class="fas fa-file-alt nav-icon"></i>
                                        <p>Agent Activity</p>
                                    </a>
                            ...
                            @can("report-mailer-lead-result")
                                <li class="nav-item">
                                    <a
                                        href="{{ route("agentreport.mailerLeadReport") }}"
                                        class="nav-link {{ request()->routeIs("agentreport.mailerLeadReport") ? "active" : "" }}"
                                    >
                            ...
                            @can("report-daily-call-result")
                                <li class="nav-item">
                                    <a
                                        href="{{ route("agentreport.daillyCallReport") }}"
                                        class="nav-link {{ request()->routeIs("agentreport.daillyCallReport") ? "active" : "" }}"
                                    >
                ...
                @can("report-tracker-from")
                    <li
                        class="nav-item has-treeview {{ request()->routeIs("agentreport.activityIndex") || request()->routeIs("agentreport.mailerLeadIndex") ? "menu-open" : "" }}"
                    >
                        <a href="#" class="nav-link">
                            <i class="fas fa-chart-line nav-icon"></i>
                            <p>
                        ...
                        <ul class="nav nav-treeview">
                            @can("report-activity-form")
                                <li class="nav-item">
                                    <a
                                        href="{{ route("agentreport.activityIndex") }}"
                                        class="nav-link {{ request()->routeIs("agentreport.activityIndex") ? "active" : "" }}"
                                    >
                            ...
                            @can("report-mailer-lead-form")
                                <li class="nav-item">
                                    <a
                                        href="{{ route("agentreport.mailerLeadIndex") }}"
                                        class="nav-link {{ request()->routeIs("agentreport.mailerLeadIndex") ? "active" : "" }}"
                                    >
