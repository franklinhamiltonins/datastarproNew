<div class="email-modal create-modal othermodalsection" id="emailModal">
    ...
    <div class="modal-wrapper modal-transition">
        <div class="modal-header">
            ...
            <h2 class="modal-heading hide-create-form">
                Send email to
                <span id="emailToContact"></span>
            </h2>
            ...
            <div class="modal-content">
                <form id="myFormSendEmail" class="create-template-form">
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            id="email_content"
                            class="form-control border-dark ckeditor"
                            name="email_content"
                            row="10"
                    ...
                    <div class="placeholders d-flex flex-wrap mb-2">
                        <span
                            class="addPlaceholder insert-placeholder font-weight-semibold p-2 border small"
                            data-placeholder="{CANDIDATE_FIRST_NAME}"
                        >
                            {CANDIDATE_FIRST_NAME}
                        </span>
                        <span
                            class="addPlaceholder insert-placeholder font-weight-semibold p-2 border small"
                            data-placeholder="{CANDIDATE_LAST_NAME}"
                        >
                            {CANDIDATE_LAST_NAME}
                        </span>
                    ...
                    <p class="small text-secondary mb-1">
                        While writing you email content, click these buttons to insert placeholders.
                    </p>
                    ...
                    <div class="text-left modal-btns mt-3 pt-3">
                        ...
                        <input
                            type="submit"
                            value="Send"
                            class="btn btn-primary btn-sm hide-create-form-button"
                            {{ $smtpData < 1 ? "disabled" : "" }}
                            title="{{ $smtpData > 0 ? "" : "Please add your SMTP configuration to send email." }}"
                        />
                        <input
                            type="button"
                            id="saveEmailTemplate"
                            value="Save Template"
                            class="btn btn-primary btn-sm show-create-form-button"
                            style="display: none"
                        />
                    </div>
                    @if ($smtpData < 1)
                        <div style="margin: 12px 0">
                            <p class="small mandatoryClass">
                                Please add your
                                <a href="{{ route("smtp.settings") }}">SMTP configuration</a>
                                to send email.
                            </p>
                        </div>
                    @endif
