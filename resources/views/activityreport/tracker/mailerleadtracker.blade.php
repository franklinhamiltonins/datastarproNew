                            ...
                            <form id="mail_lead_tracker">
                                ...
                                <div class="form-row p-3">
                                    <input
                                        type="hidden"
                                        name="mailer_id"
                                        value="{{ $edit && $mailLead ? $mailLead->id : "" }}"
                                    />
                                    ...
                                    <div class="form-group col-12 col-md-6 col-lg-4 mb-2">
                                        ...
                                        <input
                                            ...
                                            name="date"
                                            type="date"
                                            value="{{ $edit && $mailLead ? $mailLead->date : date("d-m-Y") }}"
                                        />
                                    </div>
                                    ...
                                    <div class="form-group col-12 col-md-6 col-lg-4 mb-2">
                                        <strong>
                                            Business Name
                                            <sup class="subMandatoryClass">*</sup>
                                            :
                                        </strong>
                                        <input
                                            ...
                                            name="business"
                                            type="text"
                                            value="{{ $edit && $mailLead ? $mailLead->business : "" }}"
                                        />
                                    </div>
                                    <div class="form-group col-12 col-md-6 col-lg-4 mb-2">
                                        <strong>
                                        ...
                                        <select class="form-control" name="business_type" id="business_type">
                                            ...
                                            <option
                                                value="Condo"
                                                @if($edit && $mailLead->business_type == "Condo") {{ 'selected' }} @endif
                                            >
                                                Condo
                                            </option>
                                            <option
                                                value="HOA"
                                                @if($edit && $mailLead->business_type == "HOA") {{ 'selected' }} @endif
                                            >
                                                HOA
                                            </option>
                                            <option
                                                value="Commercial"
                                                @if($edit && $mailLead->business_type == "Commercial") {{ 'selected' }} @endif
                                            >
                                                Commercial
                                            </option>
                                            <option
                                                value="Co-Op"
                                                @if($edit && $mailLead->business_type == "Co-Op") {{ 'selected' }} @endif
                                            >
                                                Co-Op
                                            </option>
                                        </select>
                                    ...
                                    <div class="form-group col-12 col-md-6 col-lg-4 mb-2">
                                        ...
                                        <input
                                            ...
                                            type="text"
                                            value="{{ $edit && $mailLead ? $mailLead->business_address : "" }}"
                                    ...
                                    <div class="form-group col-12 col-md-6 col-lg-4 mb-2">
                                        ...
                                        <input
                                            ...
                                            name="business_city"
                                            type="text"
                                            value="{{ $edit && $mailLead ? $mailLead->business_city : "" }}"
                                        />
                                    </div>
                                    <div class="form-group col-12 col-md-6 col-lg-4 mb-2">
                                        <strong>
                                        ...
                                        <input
                                            placeholder="Business Zip - 5 digits"
                                            class="form-control"
                                            name="business_zip"
                                            type="text"
                                            maxlength="5"
                                            value="{{ $edit && $mailLead ? $mailLead->business_zip : "" }}"
                                        />
                                    </div>
                                    ...
                                    <div class="form-group col-12 col-md-6 col-lg-4 mb-2">
                                        ...
                                        <input
                                            ...
                                            type="text"
                                            value="{{ $edit && $mailLead ? $mailLead->contact_firstname : "" }}"
                                        />
                                    </div>
                                    <div class="form-group col-12 col-md-6 col-lg-4 mb-2">
                                        <strong>
                                        ...
                                        <input
                                            ...
                                            type="text"
                                            value="{{ $edit && $mailLead ? $mailLead->contact_lastname : "" }}"
                                        />
                                    </div>
                                    <div class="form-group col-12 col-md-6 col-lg-4 mb-2">
                                        <strong>
                                        ...
                                        <input
                                            ...
                                            name="phone"
                                            type="text"
                                            value="{{ $edit && $mailLead ? $mailLead->phone : "" }}"
                                        />
                                    </div>
                                    <div class="form-group col-12 col-md-6 col-lg-4 mb-2">
                                        ...
                                        <input
                                            ...
                                            name="email_address"
                                            type="text"
                                            value="{{ $edit && $mailLead ? $mailLead->email_address : "" }}"
                                        />
                                    </div>
                                    <div class="form-group col-12 col-md-6 col-lg-4 mb-2">
                                        <strong>
                                        ...
                                        <input
                                            ...
                                            type="text"
                                            value="{{ $edit && $mailLead ? $mailLead->contact_address : "" }}"
                                            pattern="^\d[0-9a-zA-Z\s\/#,._\-:]*$"
                                            title="Address must start with a digit and contain only letters, numbers, spaces, and / # , . _ - :"
                                        />
                                    </div>
                                            ...
                                            @foreach ($statusOptions as $keyStatus => $statusOption)
                                                @if (! empty($statusOption->false_status) && $statusOption->false_status == 1)
                                                    <option
                                                        ...
                                                        @if($statusOption->id == $selcted_status && $status_selected == 0) <?php $status_selected = 1; ?> {{ 'selected' }} @endif
                                                    >
                                                        {{ $statusOption->name }}
                                                    </option>
                                                @endif
                                    ...
                                    <div class="form-group col-12 mb-2">
                                        ...
                                        <textarea
                                            ...
                                            rows="4"
                                        >
{{ trim($edit && $mailLead ? $mailLead->status_note : "") }}</textarea
                                        >
                                    </div>
                                </div>
                            ...
                            <div class="px-3 pb-4">
                                <div class="alert alert-light border mt-2 small">
                                    <p class="mb-1">
                                        <sup class="mandatoryClass">*</sup>
                                        — Required field for
                                        <strong>Mailer Lead Tracker form submission</strong>
                                    </p>
                                    <p class="mb-0">
                                        <sup class="subMandatoryClass">*</sup>
                                        — Required field for
                                        <strong>Business creation</strong>
                                        after Mailer Lead Tracker form submission
                                    </p>
                                </div>
                            </div>
                        </div>
