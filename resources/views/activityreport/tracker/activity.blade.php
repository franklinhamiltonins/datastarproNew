                                ...
                                <div class="form-row p-3">
                                    ...
                                    <div class="form-group col-12 col-md-6 col-lg-4 mb-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input
                                                placeholder="Expiring Policy Premium "
                                    ...
                                    <div id="aor-container" class="col-12 mb-2">
                                        <div
                                            class="aor-group-outer border pb-2 pt-4 px-3 rounded mt-2 mb-4 position-relative"
                                        >
                                            <!-- AOR Group Template -->
                                            <span
                                                class="position-absolute aor-group-head bg-secondary px-3 py-1 rounded-lg text-sm"
                                            >
                                                AOR Group
                                            </span>
                                            <div class="aor-group row" data-index="0">
                                                ...
                                                <div class="form-group col-12 col-md-6 col-lg-3 mb-2">
                                                    ...
                                                    <input
                                                        placeholder="AOR (Community Name)"
                                                        class="form-control"
                                                        name="aor[0][aor_community_name]"
                                                        type="text"
                                                    />
                                                </div>
                                                <div class="form-group col-12 col-md-6 col-lg-3 mb-2">
                                                    ...
                                                    <input
                                                        placeholder="AOR MONTH Effective Date"
                                                        class="form-control"
                                                        name="aor[0][aor_effective_date]"
                                                        type="date"
                                                    />
                                                </div>
                                                <div class="form-group col-12 col-md-6 col-lg-3 mb-2">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-text rounded-right-0">$</span>
                                                        <input
                                                            placeholder="Expiring AOR Premium "
                                                            class="form-control rounded-left-0"
                                                            step="any"
                                                            aria-label="Dollar amount (with dot and two decimal places"
                                                            id="premium"
                                                            maxlength="10"
                                                            oninput="restrictInput(this, 10)"
                                                            name="aor[0][expiring_aor_premium]"
                                                            type="number"
                                                        />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-12 mb-3">
                                        <button type="button" class="btn btn-sm btn-primary" onclick="addAORGroup()">
                                            Add Another AOR
                                        </button>
                                    </div>
    ...
    <script>
        ...
        function renderFileList() {
            ...
            selectedFiles.forEach((file, index) => {
                ...
                fileItem.className =
                    'd-flex align-items-center justify-content-between border rounded p-2 mb-2 bg-light';
        ...
        $('#agent_activity_reports').on('submit', function (e) {
            ...
            $.ajax({
                ...
                beforeSend: function () {
                    $('body').append(
                        `{!! trim(preg_replace("/\s+/", " ", view("partials.formSubmission_loader")->render())) !!}`,
                    );
                },
