...
<body style="margin: 0;">
    ...
    <table style="width: 100%;border-spacing: 0;background-color: #fff;padding: 0 10px 0; font-family: Google Sans,Roboto,sans-serif; font-size: 13px; color: #646464;">
            ...
            <td>
                <table style="width: 100%;border-spacing: 0;">
                    <tr>
                        ...
                        <td style="vertical-align: middle;text-align: left;width: 7%;min-width: 90px; padding-right: 5px; border-right: 1px solid #000;">
                        ...
                        <td style="vertical-align: middle;text-align: left;width: 80%;padding-left: 5px; margin: 0;">
                            {!! $data['signature_text'] !!}
                        </td>
                        @endif
                    </tr>
