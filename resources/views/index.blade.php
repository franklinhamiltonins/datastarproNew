            ...
            <div class="mt-2">
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-3 d-flex mb-3">
                        ...
                        >
                            <span class="info-box-icon rounded-0 mb-3 text-cyan">
                    ...
                    <div class="col-12 col-sm-6 col-md-3 d-flex mb-3">
                        <div
                            class="info-box mb-0 p-1 p-lg-4 py-3 py-lg-5 overflow-hidden d-flex flex-column align-items-center"
                        >
                            <span class="info-box-icon rounded-0 mb-3 text-danger">
                    ...
                    <div class="col-12 col-sm-6 col-md-3 d-flex mb-3">
                        <div
                            class="info-box mb-0 p-1 p-lg-4 py-3 py-lg-5 overflow-hidden d-flex flex-column align-items-center"
                        >
                            <span class="info-box-icon rounded-0 mb-3 text-primary">
                    ...
                    <div class="col-12 col-sm-6 col-md-3 d-flex mb-3">
                        <div
                            class="info-box mb-0 p-1 p-lg-4 py-3 py-lg-5 overflow-hidden d-flex flex-column align-items-center"
                        >
                            <span class="info-box-icon rounded-0 mb-3 text-success">
