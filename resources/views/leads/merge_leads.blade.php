                ...
                <tbody>
                    ...
                    @foreach ($compareArr[0] as $index => $value)
                        <tr class="merge-tr">
                            ...
                            @foreach ($compareArr as $key => $values)
                                <td
                                    class="merge-td p-2 dynamic-td"
                                    {!! $index == "id" ? 'id="' . $values[$index] . '"' : "" !!}
                                >
                                    {!! $values[$index] !!}
                                </td>
                            @endforeach
        ...
        $(document).ready(function () {
            ...
            $('.merge_to_current_lead').click(function () {
                ...
                if (mergeLeadId && mergeLeadIdTo && columnIndex && selectedColumnIndex) {
                    ...
                    if (
                        confirm(
                            'Are you sure you want to merge the contacts from lead ' +
                                mergeLeadId +
                                ' to ' +
                                mergeLeadIdTo +
                                ' data?',
            ...
            $('#sendDataBtn').click(function () {
                if (selectedColumnIndex !== null) {
                    ...
                    $('table tr:not(:first-child)').each(function (index) {
                        ...
                        var paramValue = $(
                            'table tr:eq(' + (index + 1) + ') td:eq(' + selectedColumnIndex + ')',
                        ).text();
