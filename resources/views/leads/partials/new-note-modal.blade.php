...
>
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content p-0">
            ...
            {!! Form::open(["route" => ["leads.note_store", $lead->id], "method" => "POST", "onsubmit" => "return handleSubmit();"]) !!}
            ...
            <div class="modal-body p-2 p-lg-3">
                ...
                <div class="form-group mb-2">
                    ...
                    <select
                        class="commonClass form-control leadscontactstatus contact-info-list-select px-2 leadselectstatus"
                        name="contact_id"
                    >
                ...
                <div class="form-group mb-2">
                    ...
                    {!! Form::textarea("description", null, ["placeholder" => "Note description", "class" => "form-control px-2", "id" => "note_desc", "rows" => "15"]) !!}
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ClassicEditor.create(document.getElementById('note_desc'), {
