        ...
        <div class="modal-content p-0">
            ...
            <div class="modal-body p-0 p-lg-3">
                ...
                <div class="form-group">
                    ...
                    @csrf
                    <select
                        class="commonClass form-control leadscontactstatus contact-info-list-select noteContactEdit leadselectstatus"
                        name="contact_id"
                    >
                ...
                <div class="form-group">
                    ...
                    {!! Form::textarea("description", null, ["placeholder" => "Note description ", "class" => "form-control noteDescriptionEdit", "id" => "note_desc_edit", "rows" => "10"]) !!}
                </div>
            </div>
