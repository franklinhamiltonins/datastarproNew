        ...
        <div class="form-group">
            <div class="custom-control custom-switch">
                <input
                    ...
                    name="is_client"
                    value="1"
                    id="clientSwitch_{{ $lead ? $lead->id : 0 }}"
                />
    ...
    <div class="mb-2">
        <div class="form-row">
            ...
            <div class="form-group col mb-0">
                ...
                {!!
                    Form::select("county", isset($lead) ? array_merge([$lead->county => $lead->county], $counties) : $counties, isset($lead) ? $lead->county : [], [
                        "class" => "form-control multiple",
    ...
    <div class="mb-2">
        <div class="form-row">
            <div class="form-group col mb-0">
                ...
                {!!
                    Form::select("prop_floor", ["" => "Select any option"] + array_combine(range(1, 100), range(1, 100)), isset($lead) ? $lead->prop_floor : [], [
                        "class" => "form-control",
                        "id" => "prop_floor",
                    ])
                !!}
                    ...
                    <div class="form-row">
                        <div class="form-group col mb-0">
                            ...
                            <input
                                ...
                                class="form-control"
                                name="other_community_info"
                                type="text"
                                value="{{ $lead->other_community_info ?? "" }}"
                            />
                        </div>
                    </div>
                </div>
    ...
    @if (isset($lead))
        <div class="card card-secondary mt-4 mb-0">
            ...
            <div class="card-body p-2 p-lg-3">
                        ...
                        <div class="form-group col mb-0">
                            ...
                            {!!
                                Form::select(
                                    ...
                                    isset($lead) ? $lead->all_other_perils : "",
                                    ["class" => "form-control"],
                                )
                            !!}
                        </div>
                        <div class="form-group col mb-0">
                            ...
                            {!!
                                Form::select(
                                    ...
                                    isset($lead) ? $lead->ordinance_of_law : "",
                                    ["class" => "form-control"],
                                )
                            !!}
                        </div>
                ...
                @include(
                    "leads.partials.insurance-section",
                    [
