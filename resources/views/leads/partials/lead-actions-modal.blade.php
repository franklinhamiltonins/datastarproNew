                ...
                <div class="modal-body p-2 p-lg-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control multiple ana" name="contact_id"
                            onchange="handleContactChange(this)" required>
                        ...
                        <div id="countyOther" class="mt-2 otherInput" style="display:none; text-transform: lowercase;">
                            <input placeholder="Other Contact" class="form-control capitalize"
                                name="county-other" type="text">
                        </div>
                    </div>

                    <div class="form-group mb-3">
                        <select class="form-control multiple" name="campaign_id"
