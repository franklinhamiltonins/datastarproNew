                ...
                <div class="mb-2">
                    <div class="form-row">
                        <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                            ...
                            {!!
                                Form::date("wind_mitigation_date", null, [
                        ...
                        <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                            ...
                            {!!
                                Form::select(
                                    ...
                                    ["id" => "secondary_water_insurance", "class" => "form-control  px-1"],
                                )
                            !!}
                        </div>
                    </div>
                        ...
                        <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                            ...
                            {!!
                                Form::select(
                                    ...
                                    ["id" => "opening_protection", "class" => "form-control px-1"],
                                )
                            !!}
                        </div>
                    </div>
                ...
                <div class="mb-2">
                    <div class="form-row">
                        <div class="form-group col-12 col-md-12 col-lg-12 mb-0">
                            ...
                            {!!
                                Form::textarea("other_community_info", null, [
