<div
    ...
    tabindex="-1"
    role="dialog"
    aria-labelledby="saveagentlistTitle"
    aria-hidden="true"
>
        ...
        <div class="modal-content p-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    {!! Form::text("agent_list_name", null, ["placeholder" => "List Name", "class" => "form-control", "required"]) !!}
                </div>
                <div class="form-group">
                    <strong>Agent:</strong>
            ...
            <div class="modal-footer flex-column">
                <button class="btn btn-primary" id="save_agent_list_button" disabled>
                    Save Dialing List
                    <span
