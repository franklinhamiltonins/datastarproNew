<div class="card-body lead-update p-0">
    ...
    <div class="form-group">
        <div class="custom-control custom-switch">
            <input type="checkbox" class="custom-control-input current_clientswitch"
    ...
    <div class="mb-2">
        <div class="form-row">
            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                ...
                {!! Form::date('creation_date', null, array(
            ...
            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                ...
                {!! Form::number('total_square_footage', null, array(
            ...
            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                ...
                {!! Form::number('unit_count', null, array(
                    'placeholder' => 'Unit - max 4 digits',
                    'class' => 'form-control',
                    'max' => 9999,
                    'id'=> 'unit_count',
                    'oninput' => 'restrictInput(this, 4)'
                )) !!}
            </div>
        </div>
    </div>
    ...
    <div class="form-row">
        <div class="form-group col-12 col-md-6">
            ...
            {!! Form::textarea('address1', null, array(
        ...
        <div class="form-group col-12 col-md-6">
            ...
            {!! Form::textarea('address2', null, array(
        ...
        <div class="form-row">
            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                ...
                {!! Form::select('county',isset($lead) ?
                    array_merge(array($lead->county=>$lead->county),$counties):$counties ,
            ...
            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                ...
                <div class="input-group">
                    ...
                    {!! Form::number('business_tiv', null, array(
                        'id' => 'business_tiv',
                        'placeholder' => 'T.I.V.',
        ...
        <div class="form-row">
            ...
            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                ...
                {!! Form::select('state', $states, isset($lead) ? $lead->state : 'FL',
                    array('class' => 'form-control multiple USstates px-1','id'=>'state')) !!}
            </div>
            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
        ...
        <div class="form-row">
            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                ...
                <input placeholder="Appraiser Name" class="form-control" name="appraisal_name"
                       type="text" value="{{$lead->appraisal_name}}" id="appraisal_name">
            </div>
            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                <strong>Appraisal Company:</strong>
                <input placeholder="Appraisal Company" class="form-control" name="appraisal_company"
                       type="text" value="{{$lead->appraisal_company}}" id="appraisal_company">
            </div>
            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                <strong>Apraisal Date:</strong>
                {!! Form::date('appraisal_date', null, array(
                    'id' => 'appraisal_date',
        ...
        <div class="form-row">
            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                ...
                {!! Form::select('ins_flood',array(
                    'No'=>'No',
                    'Yes'=>'Yes',
                ),isset($lead) ? $lead->ins_flood : [],
                    array('class' => 'form-control multiple px-1','id'=>'ins_flood')) !!}
            </div>
            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                <strong>Property Floors:</strong>
                {!! Form::select('prop_floor',[''=>'Select any option'] + array_combine(range(1,100),
                    range(1,100)),isset($lead) ? $lead->prop_floor : [],
                    array('class' => 'form-control multiple px-1','id'=>'prop_floor')) !!}
            </div>
            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                <strong>Pool:</strong>
                {!! Form::select('pool',array(
                    'No'=>'No',
                    'Yes'=>'Yes',
                ),isset($lead) ? $lead->pool : [],
                    array('class' => 'form-control px-1','id'=> 'pool')) !!}
            </div>
        </div>
    </div>
        ...
        <div class="form-row">
            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                ...
                {!! Form::select('lakes',array(
                    'No'=>'No',
                    'Yes'=>'Yes',
                ),isset($lead) ? $lead->lakes : [],
                    array('class' => 'form-control px-1','id'=> 'lakes')) !!}
            </div>
            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                ...
                {!! Form::select('clubhouse',array(
                    'No'=>'No',
                    'Yes'=>'Yes',
                ),isset($lead) ? $lead->clubhouse : [],
                    array('class' => 'form-control px-1','id'=> 'clubhouse')) !!}
            </div>
            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                ...
                {!! Form::select('tennis_basketball',array(
                    'No'=>'No',
                    'Yes'=>'Yes',
                ),isset($lead) ? $lead->tennis_basketball : [],
                    array('class' => 'form-control px-1','id'=> 'tennis_basketball')) !!}
            </div>
        </div>
    </div>
    <div class="mb-2">
            ...
            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                ...
                <select name="lead_source" id="lead_source"
                    ...
                    @foreach($leadSource as $lsource)
                        <option value="{{$lsource->id}}"
                                @if($lead->lead_source == $lsource->id) {{'selected'}} @endif>
                            {{ $lsource->name }}
                        </option>
                    @endforeach
                </select>
