            ...
            <div class="col-12">
                ...
                <div class="d-flex m-0">
                    ...
                    <div class="custom-control custom-switch ml-2">
                        ...
                        <label class="custom-control-label" for="distance_query_selection_checkbox">
                            Business Name
                        </label>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-0">
                            ...
                            {!!
                                Form::text("address_text", null, [
                                    "placeholder" => "Enter address",
                                    "class" => "form-control input",
                                    "id" => "address_text_search",
                                ])
                            !!}
                            {!!
                                Form::text("lead_business_names_search", null, [
                                    "placeholder" => "Enter business name",
                                    "class" => "form-control input d-none",
                                    "id" => "lead_business_names_search",
                                    "data-filter" => "&q=#QUERY#",
                                ])
                            !!}
                            ...
                            <div class="form-group col mb-0" style="max-width: 60px">
                                ...
                                {!!
                                    Form::select(
                                        ...
                                        [],
                                        ["class" => "form-control multiple operator p-0 ml-0"],
                                    )
                                !!}
                            </div>
                            <div class="form-group col mb-0">
                                ...
                                {!!
                                    Form::text("distance", null, [
                                        ...
                                        "class" => "form-control input integer-only",
                                    ])
                                !!}
                            </div>
                        </div>
            ...
            <div class="col-12 col-md-6 inputForms search-fields">
                <div class="form-row align-items-center inputField">
                    <div class="form-group col-12 col-sm mb-2">
                        ...
                        {!! Form::select("s_name_1", $tableHeadingName, null, ["class" => "form-control multiple select ", "id" => "s_name_1", "onchange" => "changeInput(this)"]) !!}
                    </div>
                    <div class="form-group col mb-2" style="max-width: 60px">
                        ...
                        {!!
                            Form::select(
                                ...
                                ["like" => " = ", "not like" => " != "],
                                [],
                                ["class" => "form-control multiple operator p-0 ", "id" => "and_or_1"],
                            )
                        !!}
                    </div>
                    <div class="form-group col-12 col-sm mb-2">
...
<div class="row flex-wrap align-items-center justify-content-center justify-content-md-between">
    <div class="col-12 col-md-6 d-flex justify-content-center justify-content-md-start">
        ...
        <button
            ...
            id="btnFiterDialingSubmitSearch"
            onclick="filter_table('dialing')"
        >
            Filter for Dialing List
        </button>
        <button
            type="submit"
            class="btn btn-outline-primary text-nowrap btn-sm mr-3"
            id="btn_save_filter"
            onclick="openSaveFilterModal(event, 'save_new', 'save-filter')"
        >
            Save Filter
        </button>
        <button
            type="submit"
            class="btn btn-outline-primary text-nowrap btn-sm mr-3 d-none"
            id="btn_save_as_filter"
            onclick="openSaveFilterModal(event, 'save_as', 'save-filter')"
        >
            Save as Filter
        </button>
