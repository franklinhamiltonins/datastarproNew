...
<div class="modal fade modal-90-center" id="previewLeadModal" tabindex="-1" role="dialog" aria-labelledby="addNoteModalTitle" aria-hidden="true">
        ...
        <div class="modal-content p-0">
            ...
            <div class="modal-body p-3" id="printSection">
		        ...
		        <!-- <div class="modal-footer p-3 bg-light">
		            <button type="button" class="btn btn-sm btn-info mx-2 closeNote" data-dismiss="modal">Close</button>
		        </div> -->
			</div>
        </div>
    </div>
