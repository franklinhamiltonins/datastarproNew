                ...
                <div class="wrapper_content">
                    <div class="form-row">
                        <div class="form-group col-12 col-md-6 mb-2">
                            ...
                            <?php $pSelected = 0 ?>
                            <select name="ins_prop_carrier" class="form-control input selectboxcarrier px-1"
                                    placeholder="Select Carrier"
                                    onchange="getSetOtherCarrierVal(this,'ins_prop_carrier')"
                                    id="ins_prop_carrier">
                                <option value="" @if($lead->ins_prop_carrier == "")
                                    <?php $pSelected = 1 ?> {{'selected'}} @endif>Select Carrier</option>
                                @foreach($carriersWithProperty as $carrier)
                                    <option value="{{$carrier->id}}"
                                            @if($lead->ins_prop_carrier == $carrier->id)
                                                <?php $pSelected = 1 ?> {{'selected'}} @endif>
                                        {{ $carrier->name }}
                                    </option>
                                @endforeach
                        ...
                        <div class="form-group col-12 col-md-6 mb-2">
                            ...
                            {!! Form::select('renewal_carrier_month',$months,isset($lead)? $lead->renewal_carrier_month : [] ,
                                array('id' => 'renewal_carrier_month','class' => 'form-control multiple businessRenewalCarrierMonth px-1')) !!}
                        </div>
                        <div class="form-group col-12 mb-2">
                            <div id="ins_prop_carrier_div" class="mt-2 otherInput" @if($pSelected == 1) style="display:none;" @endif>
                                <input placeholder="Other Insurance Property Carrier" class="form-control"
                                       name="ins_prop_carrier-other" type="text"
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::number('premium', null, array('placeholder' => 'Expiring Premium ','class' =>
                                        ...
                                        decimal places','id'=>'premium','maxlength' => 10,'oninput' => 'restrictInput(this, 10)')) !!}
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <strong>Expiring Premium Year: </strong>
                                {!! Form::select('premium_year', $years, isset($lead)? $lead->premium_year : [] ,
                                    array('class' => 'form-control multiple premium_year px-1','id'=>'premium_year')) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                {!! Form::select('insured_year', $years, isset($lead)? $lead->insured_year : [] ,
                                    array('id' => 'insured_year','class' => 'form-control multiple insured_year px-1')) !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-12 col-md-6 mb-2">
                            ...
                            <?php $pSelectedR = 0 ?>
                            <select name="rating" class="form-control input selectboxcarrier px-1"
                                    placeholder="Select Rating"
                                    onchange="getSetOtherCarrierVal(this,'rating')"
                                    id="rating">
                                <option value="" @if($lead->rating == "") <?php $pSelectedR = 1 ?> {{'selected'}} @endif>Select Rating</option>
                                @foreach($ratingsWithProperty as $rating)
                                    <option value="{{$rating->id}}"
                                            @if($lead->rating == $rating->id)
                                                <?php $pSelectedR = 1 ?> {{'selected'}} @endif>
                                        {{ $rating->name }}
                                    </option>
                                @endforeach
                        ...
                        <div class="form-group col-12 mb-2">
                            <div id="rating_div" class="mt-2 otherInput" @if($pSelectedR == 1) style="display:none;" @endif>
                                <input placeholder="Other Insurance Property Rating" class="form-control"
                                       name="rating-other" type="text"
                    ...
                    <div class="form-row">
                        <div class="form-group col-12 col-md-6 mb-2">
                            ...
                            '10'=>'10%',
                                ...
                                array('id' => 'hurricane_deductible','class' => 'form-control px-1')) !!}
                        </div>
                        <div class="form-group col-12 col-md-6 mb-2">
                            ...
                            'Per Year'=>'Per Year',
                                ...
                                array('id' => 'hurricane_deductible_occurrence','class' => 'form-control px-1')) !!}
                        </div>
                    </div>
                    <div class="mb-2">
                        <div class="form-row">
                            ...
                            <div class="form-group col-12 col-md-6 mb-0">
                                ...
                                <?php $oflSelected = 0 ?>
                                <select id="ordinance_of_law" class="form-control px-1" name="ordinance_of_law"
                                        onchange="getSetOtherCarrierVal(this,'ordinance_of_law')">
                                    <option value="" @if($lead->ordinance_of_law === "" || $lead->ordinance_of_law === null)
                                        <?php $oflSelected = 1 ?> {{'selected'}} @endif>Select Ordinance of Law</option>
                                    <option value="0" @if($lead->ordinance_of_law == 0 && $oflSelected == 0)
                                        <?php $oflSelected = 1 ?> {{'selected'}} @endif>0%</option>
                                    <option value="1" @if($lead->ordinance_of_law == 1)
                                        <?php $oflSelected = 1 ?> {{'selected'}} @endif>1%</option>
                                    <option value="2.5" @if($lead->ordinance_of_law == 2.5)
                                        <?php $oflSelected = 1 ?> {{'selected'}} @endif>2.5%</option>
                                    <option value="3" @if($lead->ordinance_of_law == 3)
                                        <?php $oflSelected = 1 ?> {{'selected'}} @endif>3%</option>
                                    <option value="5" @if($lead->ordinance_of_law == 5)
                                        <?php $oflSelected = 1 ?> {{'selected'}} @endif>5%</option>
                                    <option value="10" @if($lead->ordinance_of_law == 10)
                                        <?php $oflSelected = 1 ?> {{'selected'}} @endif>10%</option>
                                    <option value="other" @if($oflSelected == 0) {{'selected'}} @endif>Others</option>
                                </select>
                            </div>
                            <div class="form-group col-12 mb-2">
                                <div id="ordinance_of_law_div" class="mt-2 otherInput" @if($oflSelected == 1) style="display:none;" @endif>
                                    <input placeholder="Other Ordinance of Law" class="form-control"
                                           name="ordinance_of_law-other" type="number" step="any"
                                           value="{{$lead->ordinance_of_law}}" id="ordinance_of_law-other">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-12 col-md-6 mb-0">
                                ...
                                'Yes'=>'Yes',
                                    ...
                                    array('id' => 'tiv_matches_appraisal','class' => 'form-control px-1')) !!}
                            </div>
                        </div>
                    </div>
                    <div class="mb-0">
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                ...
                                {!! Form::textarea('property_insurance_coverage', null, array('placeholder' => 'Property Notes',
                                    'class' => 'form-control d-block','id'=>'property_insurance_coverage','rows' => '4','maxlength'=>'1000')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="wrapper_content">
                    <div class="mb-2 form-group">
                        <div class="form-row">
                            <?php $glSelected = 0 ?>
                            <div class="form-group col mb-0">
                                <select name="general_liability" id="general_liability"
                                        class="form-control input selectboxcarrier px-1"
                                        placeholder="Select Carrier"
                                        onchange="getSetOtherCarrierVal(this,'general_liability')" >
                                    <option value="" @if($lead->general_liability == "")
                                        <?php $glSelected = 1 ?> {{'selected'}} @endif>Select Carrier</option>
                                    @foreach($carriersWithGeneralLiability as $carrier)
                                        <option value="{{$carrier->id}}"
                                                @if($lead->general_liability == $carrier->id)
                                                    <?php $glSelected = 1 ?> {{'selected'}} @endif>
                                            {{ $carrier->name }}
                                        </option>
                                    @endforeach
                                    <option value="other" @if($glSelected == 0) {{'selected'}} @endif>Others</option>
                                </select>
                            </div>
                            <div class="form-group col mb-0">
                                {!! Form::select('GL_ren_month',$months, $lead->GL_ren_month,
                                    array('class' => 'form-control multiple px-1','id'=>'GL_ren_month')) !!}
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                <div id="general_liability_div" class="mt-2 otherInput" @if($glSelected == 1) style="display:none;" @endif>
                                    <input placeholder="General Liability Carrier" class="form-control"
                                           name="general_liability-other" type="text"
                            ...
                            <div class="form-group col mb-0">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::number('gl_expiry_premium', null, array('placeholder' => 'Expiring Premium ','class' =>
                                        'form-control rounded-left-0','step'=>'any','aria-label'=>'Dollar amount (with dot and two
                                        decimal places','id'=>'gl_expiry_premium','oninput' => 'restrictInput(this, 8)')) !!}
                                </div>
                            </div>
                            <div class="form-group col mb-0">
                                <strong>Policy Renewal Date: </strong>
                                {!! Form::date('gl_policy_renewal_date', null, array('class' => 'form-control gl_policy_renewal_date',
                                    'id'=>'gl_policy_renewal_date')) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-12 col-md-6 mb-2">
                            <strong>Carrier Rating:</strong>
                            <?php $glSelectedR = 0 ?>
                            <select name="gl_rating" class="form-control input selectboxcarrier px-1"
                                    placeholder="Select Rating"
                                    onchange="getSetOtherCarrierVal(this,'gl_rating')"
                                    id="gl_rating">
                                <option value="" @if($lead->gl_rating == "")
                                    <?php $glSelectedR = 1 ?> {{'selected'}} @endif>Select Rating</option>
                                @foreach($ratingsWithGeneralLiability as $rating)
                                    <option value="{{$rating->id}}"
                                            @if($lead->gl_rating == $rating->id)
                                                <?php $glSelectedR = 1 ?> {{'selected'}} @endif>
                                        {{ $rating->name }}
                                    </option>
                                @endforeach
                                <option value="other" @if($glSelectedR == 0) {{'selected'}} @endif>Others</option>
                            </select>
                        </div>
                        <div class="form-group col-12 col-md-6 mb-2">
                        ...
                        <div class="form-group col-12 mb-2">
                            <div id="gl_rating_div" class="mt-2 otherInput" @if($glSelectedR == 1) style="display:none;" @endif>
                                <input placeholder="Other General Liability Rating" class="form-control"
                                       name="gl_rating-other" type="text"
                        ...
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                ...
                                {!! Form::select('gl_exclusions[]', [
                                    ...
                                    ['id'=>'gl_exclusions','class' => 'form-control  px-1', 'multiple' => true, 'size' => 1,
                                    'style' => 'height: 2rem']) !!}
                            </div>
                            <div class="form-group col mb-0">
                                <strong>Other Exclusions:</strong>
                                <input placeholder="Other Exclusions" id="gl_other_exclusions" class="form-control"
                                       name="gl_other_exclusions" type="text" value="{{ $lead->gl_other_exclusions }}">
                            </div>
                        </div>
                    </div>
                    <div class="mb-0">
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                ...
                                {!! Form::textarea('gl_insurance_coverage', null, array('placeholder' => 'General Liability Notes',
                                    'class' => 'form-control d-block','id'=>'gl_insurance_coverage','rows' => '4','maxlength'=>'1000')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="wrapper_content">
                    <div class="mb-2 form-group">
                        <div class="form-row">
                            <?php $ciSelected = 0 ?>
                            <div class="form-group col mb-0">
                                <select name="crime_insurance" id="crime_insurance"
                                        class="form-control input selectboxcarrier px-1"
                                        placeholder="Select Carrier"
                                        onchange="getSetOtherCarrierVal(this,'crime_insurance')">
                                    <option value="" @if($lead->crime_insurance == "")
                                        <?php $ciSelected = 1 ?> {{'selected'}} @endif>Select Carrier</option>
                                    @foreach($carriersWithCrimeInsurance as $carrier)
                                        <option value="{{$carrier->id}}"
                                                @if($lead->crime_insurance == $carrier->id)
                                                    <?php $ciSelected = 1 ?> {{'selected'}} @endif>
                                            {{ $carrier->name }}
                                        </option>
                                    @endforeach
                                    <option value="other" @if($ciSelected == 0) {{'selected'}} @endif>Others</option>
                                </select>
                            </div>
                            <div class="form-group col mb-0">
                                {!! Form::select('CI_ren_month',$months, $lead->CI_ren_month,
                                    array('class' => 'form-control multiple px-1','id'=>'CI_ren_month')) !!}
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                <div id="crime_insurance_div" class="mt-2 otherInput" @if($ciSelected == 1) style="display:none;" @endif>
                                    <input placeholder="Crime Insurance Carrier" class="form-control"
                                           name="crime_insurance-other" type="text"
                            ...
                            <div class="form-group col mb-0">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::number('ci_expiry_premium', null, array('placeholder' => 'Expiring Premium ','class' =>
                                        'form-control rounded-left-0','step'=>'any','aria-label'=>'Dollar amount (with dot and two
                                        decimal places','id'=>'ci_expiry_premium','oninput' => 'restrictInput(this, 8)')) !!}
                                </div>
                            </div>
                            <div class="form-group col mb-0">
                                <strong>Policy Renewal Date: </strong>
                                {!! Form::date('ci_policy_renewal_date', null, array('class' => 'form-control ci_policy_renewal_date',
                                    'id'=>'ci_policy_renewal_date')) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-12 col-md-6 mb-2">
                            ...
                            <?php $ciSelectedR = 0 ?>
                            <select name="ci_rating" class="form-control input selectboxcarrier px-1"
                                    placeholder="Select Rating"
                                    onchange="getSetOtherCarrierVal(this,'ci_rating')"
                                    id="ci_rating">
                                <option value="" @if($lead->ci_rating == "")
                                    <?php $ciSelectedR = 1 ?> {{'selected'}} @endif>Select Rating</option>
                                @foreach($ratingsWithCrimeInsurance as $rating)
                                    <option value="{{$rating->id}}"
                                            @if($lead->ci_rating == $rating->id)
                                                <?php $ciSelectedR = 1 ?> {{'selected'}} @endif>
                                        {{ $rating->name }}
                                    </option>
                                @endforeach
                                <option value="other" @if($ciSelectedR == 0) {{'selected'}} @endif>Others</option>
                            </select>
                        </div>
                        <div class="form-group col-12 col-md-6 mb-2">
                            <strong>Employee Theft:</strong>
                            {!! Form::number('employee_theft', null, array('placeholder' => 'Employee Theft ','id'=>'employee_theft','class' =>
                                'form-control rounded-left-0','step'=>'any','aria-label'=>'Dollar amount (with dot and two decimal places',
                                'oninput' => 'restrictInput(this, 7)')) !!}
                        </div>
                        <div class="form-group col-12 mb-2">
                            <div id="ci_rating_div" class="mt-2 otherInput" @if($ciSelectedR == 1) style="display:none;" @endif>
                                <input placeholder="Other Crime Insurance Rating" class="form-control"
                                       name="ci_rating-other" type="text"
                    ...
                    <div class="mb-0">
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                ...
                                {!! Form::textarea('ci_insurance_coverage', null, array('placeholder' => 'Crime Insurance Notes',
                                    'class' => 'form-control d-block','id'=>'ci_insurance_coverage','rows' => '4','maxlength'=>'1000')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="wrapper_content">
                    <div class="mb-2 form-group">
                        <div class="form-row">
                            <?php $doSelected = 0 ?>
                            <div class="form-group col mb-0">
                                <select name="directors_officers" id="directors_officers"
                                        class="form-control input selectboxcarrier px-1"
                                        placeholder="Select Carrier"
                                        onchange="getSetOtherCarrierVal(this,'directors_officers')">
                                    <option value="" @if($lead->directors_officers == "")
                                        <?php $doSelected = 1 ?> {{'selected'}} @endif>Select Carrier</option>
                                    @foreach($carriersWithDC as $carrier)
                                        <option value="{{$carrier->id}}"
                                                @if($lead->directors_officers == $carrier->id)
                                                    <?php $doSelected = 1 ?> {{'selected'}} @endif>
                                            {{ $carrier->name }}
                                        </option>
                                    @endforeach
                                    <option value="other" @if($doSelected == 0) {{'selected'}} @endif>Others</option>
                                </select>
                            </div>
                            <div class="form-group col mb-0">
                                {!! Form::select('DO_ren_month',$months, $lead->DO_ren_month,
                                    array('class' => 'form-control multiple px-1','id'=>'DO_ren_month')) !!}
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                <div id="directors_officers_div" class="mt-2 otherInput" @if($doSelected == 1) style="display:none;" @endif>
                                    <input placeholder="Directors & Officers Carrier" class="form-control"
                                           name="directors_officers-other" type="text"
                            ...
                            <div class="form-group col mb-0">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::number('do_expiry_premium', null, array('placeholder' => 'Expiring Premium ','class' =>
                                        'form-control rounded-left-0','step'=>'any','aria-label'=>'Dollar amount (with dot and two
                                        decimal places','id'=>'do_expiry_premium','oninput' => 'restrictInput(this, 8)')) !!}
                                </div>
                            </div>
                            <div class="form-group col mb-0">
                                <strong>Policy Renewal Date: </strong>
                                {!! Form::date('do_policy_renewal_date', null, array('class' => 'form-control do_policy_renewal_date',
                                    'id'=>'do_policy_renewal_date')) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-12 col-md-6 mb-2">
                            <strong>Carrier Rating:</strong>
                            <?php $doSelectedR = 0 ?>
                            <select name="do_rating" class="form-control input selectboxcarrier px-1"
                                    placeholder="Select Rating"
                                    onchange="getSetOtherCarrierVal(this,'do_rating')"
                                    id="do_rating">
                                <option value="" @if($lead->do_rating == "")
                                    <?php $doSelectedR = 1 ?> {{'selected'}} @endif>Select Rating</option>
                                @foreach($ratingsWithDirectorOfficor as $rating)
                                    <option value="{{$rating->id}}"
                                            @if($lead->do_rating == $rating->id)
                                                <?php $doSelectedR = 1 ?> {{'selected'}} @endif>
                                        {{ $rating->name }}
                                    </option>
                                @endforeach
                                <option value="other" @if($doSelectedR == 0) {{'selected'}} @endif>Others</option>
                            </select>
                        </div>
                        <div class="form-group col-12 col-md-6 mb-2">
                            ...
                            'Yes'=>'Yes',
                                ...
                                array('class' => 'form-control px-1','id'=>'claims_made')) !!}
                        </div>
                        <div class="form-group col-12 mb-2">
                            <div id="do_rating_div" class="mt-2 otherInput" @if($doSelectedR == 1) style="display:none;" @endif>
                                <input placeholder="Other Directors & Officers Rating" class="form-control"
                                       name="do_rating-other" type="text"
                        ...
                        <div class="form-row">
                            <div class="form-group col-12 col-md-6 mb-2">
                                ...
                                'Yes'=>'Yes',
                                    ...
                                    array('id'=>'pending_litigation','class' => 'form-control px-1')) !!}
                            </div>
                            <div class="form-group col-12 col-md-6 mb-2">
                    ...
                    <div class="mb-0">
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                ...
                                {!! Form::textarea('do_insurance_coverage', null, array('placeholder' => 'Directors & Officers Notes',
                                    'class' => 'form-control d-block','id'=>'do_insurance_coverage','rows' => '4','maxlength'=>'1000')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="wrapper_content">
                    <div class="mb-2 form-group">
                        <div class="form-row">
                            <?php $uSelected = 0 ?>
                            <div class="form-group col mb-0">
                                <select name="umbrella" id="umbrella"
                                        class="form-control input selectboxcarrier px-1"
                                        placeholder="Select Carrier"
                                        onchange="getSetOtherCarrierVal(this,'umbrella')">
                                    <option value="" @if($lead->umbrella == "")
                                        <?php $uSelected = 1 ?> {{'selected'}} @endif>Select Carrier</option>
                                    @foreach($carriersWithUnbrella as $carrier)
                                        <option value="{{$carrier->id}}"
                                                @if($lead->umbrella == $carrier->id)
                                                    <?php $uSelected = 1 ?> {{'selected'}} @endif>
                                            {{ $carrier->name }}
                                        </option>
                                    @endforeach
                                    <option value="other" @if($uSelected == 0) {{'selected'}} @endif>Others</option>
                                </select>
                            </div>
                            <div class="form-group col mb-0">
                                {!! Form::select('U_ren_month',$months, $lead->U_ren_month,
                                    array('class' => 'form-control multiple px-1','id'=>'U_ren_month')) !!}
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                <div id="umbrella_div" class="mt-2 otherInput" @if($uSelected == 1) style="display:none;" @endif>
                                    <input placeholder="Umbrella Carrier" class="form-control"
                                           name="umbrella-other" type="text"
                            ...
                            <div class="form-group col mb-0">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::number('umbrella_expiry_premium', null, array('placeholder' => 'Expiring Premium','class' =>
                                        'form-control rounded-left-0','step'=>'any','aria-label'=>'Dollar amount (with dot and two
                                        decimal places','id'=>'umbrella_expiry_premium','oninput' => 'restrictInput(this, 8)')) !!}
                                </div>
                            </div>
                            <div class="form-group col mb-0">
                                <strong>Policy Renewal Date: </strong>
                                {!! Form::date('umbrella_policy_renewal_date', null, array('class' => 'form-control umbrella_policy_renewal_date',
                                    'id'=>'umbrella_policy_renewal_date')) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-12 col-md-6 mb-2">
                            ...
                            {!! Form::select('umbrella_exclusions[]', [
                                ...
                                ['id'=>'umbrella_exclusions','class' => 'form-control px-1', 'multiple' => true, 'size' => 1,
                                'style' => 'height: 2rem']) !!}
                        </div>
                        <div class="form-group col-12 col-md-6 mb-2">
                            <strong>Other Exclusions:</strong>
                            <input placeholder="Other Exclusions" id="umbrella_other_exclusions" class="form-control"
                                   name="umbrella_other_exclusions" type="text" value="{{ $lead->umbrella_other_exclusions }}">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-12 col-md-6 mb-2">
                            <strong>Carrier Rating:</strong>
                            <?php $uSelectedR = 0 ?>
                            <select name="umbrella_rating" class="form-control input selectboxcarrier px-1"
                                    placeholder="Select Rating"
                                    onchange="getSetOtherCarrierVal(this,'umbrella_rating')"
                                    id="umbrella_rating">
                                <option value="" @if($lead->umbrella_rating == "")
                                    <?php $uSelectedR = 1 ?> {{'selected'}} @endif>Select Rating</option>
                                @foreach($ratingsWithUnbrella as $rating)
                                    <option value="{{$rating->id}}"
                                            @if($lead->umbrella_rating == $rating->id)
                                                <?php $uSelectedR = 1 ?> {{'selected'}} @endif>
                                        {{ $rating->name }}
                                    </option>
                                @endforeach
                        ...
                        <div class="form-group col-12 col-md-6 mb-2">
                            ...
                            'Yes'=>'Yes',
                                ...
                                array('class' => 'form-control px-1','id'=>'correct_underlying')) !!}
                        </div>
                        <div class="form-group col-12 mb-2">
                            <div id="umbrella_rating_div" class="mt-2 otherInput" @if($uSelectedR == 1) style="display:none;" @endif>
                                <input placeholder="Other Umbrella Rating" class="form-control"
                                       name="umbrella_rating-other" type="text"
                    ...
                    <div class="mb-0">
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                ...
                                {!! Form::textarea('u_insurance_coverage', null, array('placeholder' => 'Umbrella Notes',
                                    'class' => 'form-control d-block','id'=>'u_insurance_coverage','rows' => '4','maxlength'=>'1000')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="wrapper_content">
                    <div class="mb-2 form-group">
                        <div class="form-row">
                            <?php $wcSelected = 0 ?>
                            <div class="form-group col mb-0">
                                <select name="workers_compensation" id="workers_compensation"
                                        class="form-control input selectboxcarrier px-1"
                                        placeholder="Select Carrier"
                                        onchange="getSetOtherCarrierVal(this,'workers_compensation')">
                                    <option value="" @if($lead->workers_compensation == "")
                                        <?php $wcSelected = 1 ?> {{'selected'}} @endif>Select Carrier</option>
                                    @foreach($carriersWithWorkCompensation as $carrier)
                                        <option value="{{$carrier->id}}"
                                                @if($lead->workers_compensation == $carrier->id)
                                                    <?php $wcSelected = 1 ?> {{'selected'}} @endif>
                                            {{ $carrier->name }}
                                        </option>
                                    @endforeach
                                    <option value="other" @if($wcSelected == 0) {{'selected'}} @endif>Others</option>
                                </select>
                            </div>
                            <div class="form-group col mb-0">
                                {!! Form::select('WC_ren_month',$months, $lead->WC_ren_month,
                                    array('class' => 'form-control multiple px-1','id'=>'WC_ren_month')) !!}
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                <div id="workers_compensation_div" class="mt-2 otherInput" @if($wcSelected == 1) style="display:none;" @endif>
                                    <input placeholder="Workers Compensation Carrier" class="form-control"
                                           name="workers_compensation-other" type="text"
                            ...
                            <div class="form-group col mb-0">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::number('wc_expiry_premium', null, array('placeholder' => 'Expiring Premium','class' =>
                                        'form-control rounded-left-0','step'=>'any','aria-label'=>'Dollar amount (with dot and two
                                        decimal places','id'=>'wc_expiry_premium','oninput' => 'restrictInput(this, 8)')) !!}
                                </div>
                            </div>
                            <div class="form-group col mb-0">
                                <strong>Policy Renewal Date: </strong>
                                {!! Form::date('wc_policy_renewal_date', null, array('class' => 'form-control wc_policy_renewal_date',
                                    'id'=>'wc_policy_renewal_date')) !!}
                            </div>
                        </div>
                    </div>
                    <div class="mb-2">
                        <div class="form-row">
                            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                                <strong>Carrier Rating:</strong>
                                <?php $wcSelectedR = 0 ?>
                                <select name="wc_rating" class="form-control input selectboxcarrier px-1"
                                        placeholder="Select Rating"
                                        onchange="getSetOtherCarrierVal(this,'wc_rating')"
                                        id="wc_rating">
                                    <option value="" @if($lead->wc_rating == "")
                                        <?php $wcSelectedR = 1 ?> {{'selected'}} @endif>Select Rating</option>
                                    @foreach($ratingsWithWorkCompensation as $rating)
                                        <option value="{{$rating->id}}"
                                                @if($lead->wc_rating == $rating->id)
                                                    <?php $wcSelectedR = 1 ?> {{'selected'}} @endif>
                                            {{ $rating->name }}
                                        </option>
                                    @endforeach
                                    <option value="other" @if($wcSelectedR == 0) {{'selected'}} @endif>Others</option>
                                </select>
                            </div>
                            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                            ...
                            <div class="form-group col-12">
                                <div id="wc_rating_div" class="mt-2 otherInput" @if($wcSelectedR == 1) style="display:none;" @endif>
                                    <input placeholder="Other Workers Compensation Rating" class="form-control"
                                           name="wc_rating-other" type="text"
                    ...
                    <div class="mb-0">
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                ...
                                {!! Form::textarea('wc_insurance_coverage', null, array('placeholder' => 'Workers Compensation Notes',
                                    'class' => 'form-control d-block','id'=>'wc_insurance_coverage','rows' => '4','maxlength'=>'1000')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="wrapper_content">
                    <div class="mb-2 form-group">
                        <div class="form-row">
                            <?php $fSelected = 0 ?>
                            <div class="form-group col mb-0">
                                <select name="flood" id="flood"
                                        class="form-control input selectboxcarrier px-1"
                                        placeholder="Select Carrier"
                                        onchange="getSetOtherCarrierVal(this,'flood')">
                                    <option value="" @if($lead->flood == "")
                                        <?php $fSelected = 1 ?> {{'selected'}} @endif>Select Carrier</option>
                                    @foreach($carriersWithFlood as $carrier)
                                        <option value="{{$carrier->id}}"
                                                @if($lead->flood == $carrier->id)
                                                    <?php $fSelected = 1 ?> {{'selected'}} @endif>
                                            {{ $carrier->name }}
                                        </option>
                                    @endforeach
                                    <option value="other" @if($fSelected == 0) {{'selected'}} @endif>Others</option>
                                </select>
                            </div>
                            <div class="form-group col mb-0">
                                {!! Form::select('F_ren_month',$months, $lead->F_ren_month,
                                    array('class' => 'form-control multiple px-1','id'=>'F_ren_month')) !!}
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                <div id="flood_div" class="mt-2 otherInput" @if($fSelected == 1) style="display:none;" @endif>
                                    <input placeholder="Flood Carrier" class="form-control"
                                           name="flood-other" type="text"
                            ...
                            <div class="form-group col mb-0">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::number('flood_expiry_premium', null, array('placeholder' => 'Expiring Premium','class' =>
                                        'form-control rounded-left-0','step'=>'any','aria-label'=>'Dollar amount (with dot and two
                                        decimal places','id'=>'flood_expiry_premium','oninput' => 'restrictInput(this, 8)')) !!}
                                </div>
                            </div>
                            <div class="form-group col mb-0">
                                <strong>Policy Renewal Date: </strong>
                                {!! Form::date('flood_policy_renewal_date', null, array('class' => 'form-control flood_policy_renewal_date',
                                    'id'=>'flood_policy_renewal_date')) !!}
                            </div>
                        </div>
                    </div>
                    <div class="mb-2">
                        <div class="form-row">
                            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                                <strong>Carrier Rating:</strong>
                                <?php $fSelectedR = 0 ?>
                                <select name="flood_rating" class="form-control input selectboxcarrier px-1"
                                        placeholder="Select Rating"
                                        onchange="getSetOtherCarrierVal(this,'flood_rating')"
                                        id="flood_rating">
                                    <option value="" @if($lead->flood_rating == "")
                                        <?php $fSelectedR = 1 ?> {{'selected'}} @endif>Select Rating</option>
                                    @foreach($ratingsWithFlood as $rating)
                                        <option value="{{$rating->id}}"
                                                @if($lead->flood_rating == $rating->id)
                                                    <?php $fSelectedR = 1 ?> {{'selected'}} @endif>
                                            {{ $rating->name }}
                                        </option>
                                    @endforeach
                                    <option value="other" @if($fSelectedR == 0) {{'selected'}} @endif>Others</option>
                                </select>
                            </div>
                            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                                ...
                                'Yes'=>'Yes',
                                    ...
                                    array('class' => 'form-control px-1','id'=>'elevation_certificate')) !!}
                            </div>
                            <div class="form-group col-12 col-md-6 col-lg-4 mb-0">
                                ...
                                'Yes'=>'Yes',
                                    ...
                                    array('class' => 'form-control px-1','id'=>'loma_letter')) !!}
                            </div>
                            <div class="form-group col-12 mb-0">
                                <div id="flood_rating_div" class="mt-2 otherInput" @if($fSelectedR == 1) style="display:none;" @endif>
                                    <input placeholder="Other Flood Rating" class="form-control"
                                           name="flood_rating-other" type="text"
                    ...
                    <div class="mb-0">
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                ...
                                {!! Form::textarea('f_insurance_coverage', null, array('placeholder' => 'Flood Notes',
                                    'class' => 'form-control d-block','id'=>'f_insurance_coverage','rows' => '4','maxlength'=>'1000')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="wrapper_content">
                    <div class="mb-2 form-group">
                        <div class="form-row">
                            <?php $dicSelected = 0 ?>
                            <div class="form-group col mb-0">
                                <select name="difference_in_condition" id="difference_in_condition"
                                        class="form-control input selectboxcarrier px-1"
                                        placeholder="Select Carrier"
                                        onchange="getSetOtherCarrierVal(this,'difference_in_condition')">
                                    <option value="" @if($lead->difference_in_condition == "")
                                        <?php $dicSelected = 1 ?> {{'selected'}} @endif>Select Carrier</option>
                                    @foreach($carriersWithDC as $carrier)
                                        <option value="{{$carrier->id}}"
                                                @if($lead->difference_in_condition == $carrier->id)
                                                    <?php $dicSelected = 1 ?> {{'selected'}} @endif>
                                            {{ $carrier->name }}
                                        </option>
                                    @endforeach
                                    <option value="other" @if($dicSelected == 0) {{'selected'}} @endif>Others</option>
                                </select>
                            </div>
                            <div class="form-group col mb-0">
                                {!! Form::select('dic_ren_month',$months, $lead->dic_ren_month,
                                    array('class' => 'form-control multiple px-1','id'=>'dic_ren_month')) !!}
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                <div id="difference_in_condition_div" class="mt-2 otherInput" @if($dicSelected == 1) style="display:none;" @endif>
                                    <input placeholder="Difference In Conditions Carrier" class="form-control"
                                           name="difference_in_condition-other" type="text"
                            ...
                            <div class="form-group col mb-0">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::number('dic_expiry_premium', null, array('placeholder' => 'Expiring Premium','class' =>
                                        'form-control rounded-left-0','step'=>'any','aria-label'=>'Dollar amount (with dot and two
                                        decimal places','id'=>'dic_expiry_premium','oninput' => 'restrictInput(this, 8)')) !!}
                                </div>
                            </div>
                            <div class="form-group col mb-0">
                                <strong>Policy Renewal Date: </strong>
                                {!! Form::date('dic_policy_renewal_date', null, array('class' => 'form-control dic_policy_renewal_date',
                                    'id'=>'dic_policy_renewal_date')) !!}
                            </div>
                        </div>
                    </div>
                    <div class="mb-2">
                        <div class="form-row">
                            ...
                            <div class="form-group col-12 col-md-6 mb-2">
                                ...
                                <input placeholder="All Other Perils Deductible" class="form-control"
                                       name="dic_all_other_perils" type="text" value="{{$lead->dic_all_other_perils}}"
                    ...
                    <div class="mb-0">
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                ...
                                {!! Form::textarea('dic_insurance_coverage', null, array('placeholder' => 'Difference In Conditions Notes',
                                    'class' => 'form-control d-block','id'=>'dic_insurance_coverage','rows' => '4','maxlength'=>'1000')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="wrapper_content">
                    <div class="mb-2 form-group">
                        <div class="form-row">
                            <?php $xwSelected = 0 ?>
                            <div class="form-group col mb-0">
                                <select name="x_wind" id="x_wind"
                                        class="form-control input selectboxcarrier px-1"
                                        placeholder="Select Carrier"
                                        onchange="getSetOtherCarrierVal(this,'x_wind')">
                                    <option value="" @if($lead->x_wind == "")
                                        <?php $xwSelected = 1 ?> {{'selected'}} @endif>Select Carrier</option>
                                    @foreach($carriersWithXW as $carrier)
                                        <option value="{{$carrier->id}}"
                                                @if($lead->x_wind == $carrier->id)
                                                    <?php $xwSelected = 1 ?> {{'selected'}} @endif>
                                            {{ $carrier->name }}
                                        </option>
                                    @endforeach
                                    <option value="other" @if($xwSelected == 0) {{'selected'}} @endif>Others</option>
                                </select>
                            </div>
                            <div class="form-group col mb-0">
                                {!! Form::select('xw_ren_month',$months, $lead->xw_ren_month,
                                    array('class' => 'form-control multiple px-1','id'=>'xw_ren_month')) !!}
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                <div id="x_wind_div" class="mt-2 otherInput" @if($xwSelected == 1) style="display:none;" @endif>
                                    <input placeholder="X-Wind Carrier" class="form-control"
                                           name="x_wind-other" type="text"
                            ...
                            <div class="form-group col mb-0">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::number('xw_expiry_premium', null, array('placeholder' => 'Expiring Premium','class' =>
                                        'form-control rounded-left-0','step'=>'any','aria-label'=>'Dollar amount (with dot and two
                                        decimal places','id'=>'xw_expiry_premium','oninput' => 'restrictInput(this, 8)')) !!}
                                </div>
                            </div>
                            <div class="form-group col mb-0">
                                <strong>Policy Renewal Date: </strong>
                                {!! Form::date('xw_policy_renewal_date', null, array('class' => 'form-control xw_policy_renewal_date',
                                    'id'=>'xw_policy_renewal_date')) !!}
                            </div>
                        </div>
                    </div>
                    <div class="mb-2">
                        <div class="form-row">
                            ...
                            <div class="form-group col-12 col-md-6 mb-2">
                                <strong>All Other Perils Deductible: </strong>
                                <input placeholder="All Other Perils Deductible" class="form-control"
                                       name="xw_all_other_perils" type="text" value="{{$lead->xw_all_other_perils}}"
                    ...
                    <div class="mb-0">
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                ...
                                {!! Form::textarea('xw_insurance_coverage', null, array('placeholder' => 'X-Wind Notes',
                                    'class' => 'form-control d-block','id'=>'xw_insurance_coverage','rows' => '4','maxlength'=>'1000')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="wrapper_content">
                    <div class="mb-2 form-group">
                        <div class="form-row">
                            <?php $ebSelected = 0 ?>
                            <div class="form-group col mb-0">
                                <select name="equipment_breakdown" id="equipment_breakdown"
                                        class="form-control input selectboxcarrier px-1"
                                        placeholder="Select Carrier"
                                        onchange="getSetOtherCarrierVal(this,'equipment_breakdown')">
                                    <option value="" @if($lead->equipment_breakdown == "")
                                        <?php $ebSelected = 1 ?> {{'selected'}} @endif>Select Carrier</option>
                                    @foreach($carriersWithEB as $carrier)
                                        <option value="{{$carrier->id}}"
                                                @if($lead->equipment_breakdown == $carrier->id)
                                                    <?php $ebSelected = 1 ?> {{'selected'}} @endif>
                                            {{ $carrier->name }}
                                        </option>
                                    @endforeach
                                    <option value="other" @if($ebSelected == 0) {{'selected'}} @endif>Others</option>
                                </select>
                            </div>
                            <div class="form-group col mb-0">
                                {!! Form::select('eb_ren_month',$months, $lead->eb_ren_month,
                                    array('class' => 'form-control multiple px-1','id'=>'eb_ren_month')) !!}
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                <div id="equipment_breakdown_div" class="mt-2 otherInput" @if($ebSelected == 1) style="display:none;" @endif>
                                    <input placeholder="Equipment Breakdown Carrier" class="form-control"
                                           name="equipment_breakdown-other" type="text"
                            ...
                            <div class="form-group col mb-0">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::number('eb_expiry_premium', null, array('placeholder' => 'Expiring Premium','class' =>
                                        'form-control rounded-left-0','step'=>'any','aria-label'=>'Dollar amount (with dot and two
                                        decimal places','id'=>'eb_expiry_premium','oninput' => 'restrictInput(this, 8)')) !!}
                                </div>
                            </div>
                            <div class="form-group col mb-0">
                                <strong>Policy Renewal Date: </strong>
                                {!! Form::date('eb_policy_renewal_date', null, array('class' => 'form-control eb_policy_renewal_date',
                                    'id'=>'eb_policy_renewal_date')) !!}
                            </div>
                        </div>
                    </div>
                    <div class="mb-2">
                        <div class="form-row">
                            ...
                            <div class="form-group col-12 col-md-6 mb-2">
                                <strong>All Other Perils Deductible: </strong>
                                <input placeholder="All Other Perils Deductible" class="form-control"
                                       name="eb_all_other_perils" type="text" value="{{$lead->eb_all_other_perils}}"
                    ...
                    <div class="mb-0">
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                ...
                                {!! Form::textarea('eb_insurance_coverage', null, array('placeholder' => 'Equipment Breakdown Notes',
                                    'class' => 'form-control d-block','id'=>'eb_insurance_coverage','rows' => '4','maxlength'=>'1000')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="wrapper_content">
                    <div class="mb-2 form-group">
                        <div class="form-row">
                            <?php $caSelected = 0 ?>
                            <div class="form-group col mb-0">
                                <select name="commercial_automobiles" id="commercial_automobiles"
                                        class="form-control input selectboxcarrier px-1"
                                        placeholder="Select Carrier"
                                        onchange="getSetOtherCarrierVal(this,'commercial_automobiles')">
                                    <option value="" @if($lead->commercial_automobiles == "")
                                        <?php $caSelected = 1 ?> {{'selected'}} @endif>Select Carrier</option>
                                    @foreach($carriersWithCA as $carrier)
                                        <option value="{{$carrier->id}}"
                                                @if($lead->commercial_automobiles == $carrier->id)
                                                    <?php $caSelected = 1 ?> {{'selected'}} @endif>
                                            {{ $carrier->name }}
                                        </option>
                                    @endforeach
                                    <option value="other" @if($caSelected == 0) {{'selected'}} @endif>Others</option>
                                </select>
                            </div>
                            <div class="form-group col mb-0">
                                {!! Form::select('ca_ren_month',$months, $lead->ca_ren_month,
                                    array('class' => 'form-control multiple px-1','id'=>'ca_ren_month')) !!}
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                <div id="commercial_automobiles_div" class="mt-2 otherInput" @if($caSelected == 1) style="display:none;" @endif>
                                    <input placeholder="Commercial AutoMobile Carrier" class="form-control"
                                           name="commercial_automobiles-other" type="text"
                            ...
                            <div class="form-group col mb-0">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::number('ca_expiry_premium', null, array('placeholder' => 'Expiring Premium','class' =>
                                        'form-control rounded-left-0','step'=>'any','aria-label'=>'Dollar amount (with dot and two
                                        decimal places','id'=>'ca_expiry_premium','oninput' => 'restrictInput(this, 8)')) !!}
                                </div>
                            </div>
                            <div class="form-group col mb-0">
                                <strong>Policy Renewal Date: </strong>
                                {!! Form::date('ca_policy_renewal_date', null, array('class' => 'form-control ca_policy_renewal_date',
                                    'id'=>'ca_policy_renewal_date')) !!}
                            </div>
                        </div>
                    </div>
                    <div class="mb-2">
                        <div class="form-row">
                            ...
                            <div class="form-group col-12 col-md-6 mb-2">
                                <strong>All Other Perils Deductible: </strong>
                                <input placeholder="All Other Perils Deductible" class="form-control"
                                       name="ca_all_other_perils" type="text" value="{{$lead->ca_all_other_perils}}"
                    ...
                    <div class="mb-0">
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                ...
                                {!! Form::textarea('ca_insurance_coverage', null, array('placeholder' => 'Commercial AutoMobiles  Notes',
                                    'class' => 'form-control d-block','id'=>'ca_insurance_coverage','rows' => '4','maxlength'=>'1000')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="wrapper_content">
                    <div class="mb-2 form-group">
                        <div class="form-row">
                            <?php $mSelected = 0 ?>
                            <div class="form-group col mb-0">
                                <select name="marina" id="marina"
                                        class="form-control input selectboxcarrier px-1"
                                        placeholder="Select Carrier"
                                        onchange="getSetOtherCarrierVal(this,'marina')">
                                    <option value="" @if($lead->marina == "")
                                        <?php $mSelected = 1 ?> {{'selected'}} @endif>Select Carrier</option>
                                    @foreach($carriersWithMarina as $carrier)
                                        <option  value="{{$carrier->id}}"
                                                 @if($lead->marina == $carrier->id)
                                                     <?php $mSelected = 1 ?> {{'selected'}} @endif>
                                            {{ $carrier->name }}
                                        </option>
                                    @endforeach
                                    <option value="other" @if($mSelected == 0) {{'selected'}} @endif>Others</option>
                                </select>
                            </div>
                            <div class="form-group col mb-0">
                                {!! Form::select('m_ren_month',$months, $lead->m_ren_month,
                                    array('class' => 'form-control multiple px-1','id'=>'m_ren_month')) !!}
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                <div id="marina_div" class="mt-2 otherInput" @if($mSelected == 1) style="display:none;" @endif>
                                    <input placeholder="Marina Carrier" class="form-control"
                                           name="marina-other" type="text"
                            ...
                            <div class="form-group col mb-0">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::number('m_expiry_premium', null, array('placeholder' => 'Expiring Premium','class' =>
                                        'form-control rounded-left-0','step'=>'any','aria-label'=>'Dollar amount (with dot and two
                                        decimal places','id'=>'m_expiry_premium','oninput' => 'restrictInput(this, 8)')) !!}
                                </div>
                            </div>
                            <div class="form-group col mb-0">
                                <strong>Policy Renewal Date: </strong>
                                {!! Form::date('m_policy_renewal_date', null, array('class' => 'form-control m_policy_renewal_date',
                                    'id'=>'m_policy_renewal_date')) !!}
                            </div>
                        </div>
                    </div>
                    <div class="mb-2">
                        <div class="form-row">
                            ...
                            <div class="form-group col-12 col-md-6 mb-2">
                                <strong>All Other Perils Deductible: </strong>
                                <input placeholder="All Other Perils Deductible" class="form-control"
                                       name="m_all_other_perils" type="text" value="{{$lead->m_all_other_perils}}"
                    ...
                    <div class="mb-0">
                        <div class="form-row">
                            <div class="form-group col mb-0">
                                ...
                                {!! Form::textarea('m_insurance_coverage', null, array('placeholder' => 'Marina Notes',
                                    'class' => 'form-control d-block','id'=>'m_insurance_coverage','rows' => '4','maxlength'=>'1000')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="wrapper_content additional_policy addition_policy_selection_{{$iloop}}" data-id="{{$iloop}}">
                        <div class="form-row">
                            <div class="form-group col-12 col-md-6 mb-2">
                                ...
                                <select id="policy_type{{$iloop}}" class="form-control px-1" name="policy_type[]"
                            ...
                            <div class="form-group col-12 col-md-6 mb-2">
                                ...
                                <select name="carrier[]" class="form-control input selectboxcarrier px-1"
                                        ...
                                        id="carrier{{$iloop}}">
                                    <option value="" @if($adpolicy->carrier == "")
                                        <?php $pSelected = 1 ?> {{'selected'}} @endif>Select Carrier</option>
                                    <option value="other" @if($pSelected == 0) {{'selected'}} @endif>Others</option>
                                </select>
                            </div>
                            <div class="form-group col-12 mb-2">
                                <div id="carrier{{$iloop}}_div" class="mt-2 otherInput" @if($pSelected == 1) style="display:none;" @endif>
                                    <input placeholder="Other Additional Policy Carrier" class="form-control"
                                           name="carrier{{$iloop}}-other" type="text"
                                ...
                                <div class="form-group col mb-0">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input placeholder="Expiring Premium" class="form-control expiry_premium_input"
                                               name="a_expiry_premium[]" type="number" value="{{$adpolicy->expiry_premium}}"
                                               id="a_expiry_premium{{$iloop}}" oninput="restrictInput(this, 8)">
                                    </div>
                                </div>
                                <div class="form-group col mb-0">
                                    <strong>Policy Renewal Date: </strong>
                        ...
                        <div class="mb-2">
                            <div class="form-row">
                                ...
                                <div class="form-group col-12 col-md-6 mb-2">
                                    <strong>All Other Perils Deductible: </strong>
                                    <input placeholder="All Other Perils Deductible" class="form-control"
                                           name="a_all_other_perils[]" type="text" value="{{$adpolicy->all_other_perils}}"
                        ...
                        <div class="mb-0">
                            <div class="form-row">
                                <div class="form-group col mb-0">
                                    <strong>Notes:</strong>
                                    <textarea placeholder="Notes" class="form-control d-block" id="insurance_coverage{{$iloop}}"
                                              rows="4" maxlength="1000" name="insurance_coverage[]" cols="50" >{{$adpolicy->insurance_coverage}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
