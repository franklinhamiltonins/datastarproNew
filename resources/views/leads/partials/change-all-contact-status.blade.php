<div
    class="modal fade"
    id="contactStatusModal"
    tabindex="-1"
    role="dialog"
    aria-labelledby="contactStatusModalTitle"
    aria-hidden="true"
>
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content p-0">
            ...
            {!! Form::open(["route" => ["leads.contact_status_update", $lead->id], "method" => "POST"]) !!}
            @csrf
            ...
            <div class="modal-body p-2 p-lg-3">
                ...
                <div class="form-group mb-0">
                    ...
                    <select
                        class="commonClass form-control leadscontactassignagent contact-info-list-select px-2"
                        name="c_agent_id"
                    >
