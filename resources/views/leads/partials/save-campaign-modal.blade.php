    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content p-0">
            ...
            <div class="modal-body">
                {!! Form::open(["id" => "saveCampaignForm"]) !!}
                @csrf
                <div class="form-group">
                    <strong>Campaign Name:</strong>
                    {!! Form::text("name", null, ["placeholder" => "Campaign Name", "class" => "form-control campName", "required"]) !!}
                </div>
            </div>
            <div class="modal-footer flex-column">
                <button class="btn btn-primary" id="saveCampaign-button" onclick="save_campaign(this)">
                    Save Campaign
                    <span
