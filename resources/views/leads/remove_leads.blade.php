@extends('layouts.app')
@section('pagetitle', 'Bulk Remove Leads')
@push('breadcrumbs')
<li class="breadcrumb-item"><a href="{{route('leads.index')}}">All leads</a></li>
<li class="breadcrumb-item active">Bulk Remove Leads </li>
@endpush
@section('content')
<!-- Main content -->
        ...
        <div class="row">
            <div class="col-lg-12 mb-3">
                ...
                <div class="float-right">
                    <a class="btn btn-sm btn-primary" href="{{ route('leads.index') }}"><i
                        ...
                        <form action="{{ route('leads.delete_leads') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="d-flex align-items-start justify-content-between">
                                ...
                                <button class="btn btn-outline-info importDataBtn"><i class="fas fa-file-csv"></i>
                                    Remove Leads <span class="spinner-border spinner-border-sm navicon d-none"
            ...
            <div class="col-xl-6">
                <div class="card card-secondary">
                    <div class="card-header mb-3">
                        <h3 class="card-title">Removing Leads - Information</h3>
                    </div>
                            ...
                            <div class="">
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                    ...
                                    <div class="card-body pt-3 pb-3 px-2">
                                        ...
                                        if a record is found matching Business_Name the record will be removed along
                                        with it's contacts, logs, files,actions, notes.
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="headingFour"
                                    ...
                                    <div class="card-body pt-3 pb-3 px-2">
                                        <button class="btn btn-info"> <a class="text-light "
                                                href="/download/sample_bulk_remove_leads.csv"
