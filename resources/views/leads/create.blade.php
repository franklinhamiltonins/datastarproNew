            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="pull-right">
                        <a class="btn btn-info btn-sm px-2" href="{{ route("leads.index") }}">
            ...
            <div class="row mt-2 mt-md-3">
                <div class="col-xl-12">
                    <div class="card card-secondary">
                        ...
                        {!! Form::open(["route" => "leads.store", "method" => "POST"]) !!}
                        <div class="p-3">
                        ...
                        <div class="card-footer p-2 p-lg-3">
                            ...
                            <p class="text-muted mt-2 small mb-0">
                                * You will be redirected to the new lead Edit page, in order to add contacts
                            </p>
                        </div>
                        {!! Form::close() !!}
                    </div>
