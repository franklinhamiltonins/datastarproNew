            ...
            <div class="row">
                ...
                <div class="col-6">
                    <input
                        type="text"
                        maxlength="4"
                        placeholder="Outbound value"
                        class="form-control numeric-input"
                        name="outbound_type_value"
                        id="outbound_type_value"
                    />
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <input
                        type="text"
                        maxlength="4"
                        placeholder="Inbound value"
                        class="form-control numeric-input"
                        name="inbound_type_value"
                        id="inbound_type_value"
                    />
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <select id="message_type_selection" class="form-control" {{ $type }}>
                        ...
                        <option @if(!empty($type) && $type == 1) {{ 'selected' }} @endif value="1">
                            Sms Provider
                        </option>
