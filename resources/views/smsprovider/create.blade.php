@extends('layouts.app')
@section('pagetitle', 'Create Sms Provider')
@push('breadcrumbs')
<li class="breadcrumb-item"><a href="{{route('smsprovider.index')}}">SMS Provider Management</a></li>
<li class="breadcrumb-item active">Create Sms Provider </li>
@endpush
@section('content')
<!-- Main content -->
            ...
            <div class="col-12">
                <div class="card card-secondary">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">Create New Sms Provider</h3>
                    </div>
                    {!! Form::open(array('route' => 'smsprovider.store','method'=>'POST', 'id' => 'createTemplate')) !!}
                    @csrf
                    ...
                    <div class="card-footer">
                        <button type="submit" id="updateSmsprovider" class="btn btn-primary">Save Sms Provider</button>
                    </div>
...
jQuery(document).ready(function() {
    ...
    $(document).on('click','#updateSmsprovider',function(event) {
        ...
        $('#updateSmsprovider').siblings("#smsprovider_content").val(textContent)
        if (textContent == '') {
