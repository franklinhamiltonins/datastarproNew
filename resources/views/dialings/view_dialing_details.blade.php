...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function generateActionLinks(item) {
        ...
        actionsHtml += '<a class="btn btn-sm btn-info action-btn p-1 white-img" title="View ' + moduleName +
            '" href="' + generateActionUrl('view', item.id) + '"><img src="{{asset(' / images / module / eye -
            slick.png ')}}" alt="View" style="width: 18px;"></a>';

        actionsHtml += '<a class="btn btn-sm btn-success action-btn p-1 white-img" title="Edit ' + moduleName +
            '" href="' + generateActionUrl('edit', item.id) + '"><img src="{{asset(' / images / module / edit -
            slick.png ')}}" alt="edit" style="width: 18px;"></a>';
        ...
        actionsHtml += '<img src="{{asset(' / images / module / delete - slick
            .png ')}}" alt="Delete" style="width: 18px;">';
        actionsHtml += '</a>';
