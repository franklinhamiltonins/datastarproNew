        ...
        <div class="modal-content p-0">
            ...
            <div class="modal-body p-2 p-lg-3">
                <div class="form-group m-0">
                    ...
                    {!! Form::select("agent_list[]", $agentUsers, [], ["id" => "agent_list", "class" => "form-control ml-0", "required", "multiple" => "multiple"]) !!}
                </div>
                <div class="form-group m-0" id="agentleads_dynamic">
                    <div class="form-group m-2" id="ExistingAgentListSection" style="display: none">
                        ...
                        <label class="radio-inline">{!! Form::radio("list_type", "existing", true) !!} Existing</label>
                        <label class="radio-inline">{!! Form::radio("list_type", "new") !!} New</label>
                    </div>
                    ...
                    <div class="form-group m-0" id="ExistingAgentListPopulation" style="display: none">
                        ...
                        {!! Form::select("existing_list", [], [], ["id" => "existing_list", "class" => "form-control ml-0"]) !!}
                    </div>
                </div>
            </div>
            <div class="modal-footer justify-content-start p-2 p-lg-3">
                <button class="btn btn-primary btn-sm m-0" id="save_agentleads_list_button">
                    Assign
                    <span
