    ...
    function generateBodyData(data) {
        ...
        if (data.length === 0) {
            ...
            responseDataArray.forEach(function(item) {
                ...
                bodyHtml += '<td class="tbodycolumns">' + (item.no_of_times_contacts_called ?? '') +
                    '</td>';
        ...
        if (links.length === 0) {
            ...
            links.forEach(function(link) {
                ...
                if (link.url === null) {
                    ...
                    var linkHtml = '<a class="paginationLinks next_prev_disabled" href="' + link.url +
                        '">' + link.label + '</a>';
                } else {
                    var linkHtml = '<a class="paginationLinks' + (link.label == currentPage ?
                        ' selected' : '') + '" href="' + link.url + '">' + link.label + '</a>';
                }
