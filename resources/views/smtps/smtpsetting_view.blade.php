@extends('layouts.app')
@section('pagetitle', 'SMTP Settings')
@push('breadcrumbs')
@endpush
@section('content')
<!-- Main content -->
                ...
                <div class="card card-secondary">
                    ...
                    <div class="card-body p-3">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <strong>Email<sup class="mandatoryClass">*</sup>:</strong>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <strong>Add/Update Signature Image:</strong>
                        ...
                        <div class="form-row">
                            ...
                            <strong>Email Signature Preview:</strong>
                                <table style="padding: 10px; font-family: Google Sans,Roboto,sans-serif; font-size: 13px; color: #646464;background: #fff;border-spacing: 0;width: 100%;">
...
jQuery(document).ready(function() {
    ...
    $('#createSmtp').submit(function(event) {
        ...
        // if (editorContent === '') {
        //     toastr.error('Signature Text should not be blank');
