            ...
            <div class="row">
                <div class="col-lg-12 margin-tb mb-3">
                    <div class="pull-right">
                        <a class="btn btn-info btn-sm px-2" href="{{ route("smtps.index") }}">
                        ...
                        <div class="card-header">
                            ...
                            <div class="pull-right float-right">
                                <a
                                    ...
                                    title="Edit SMTP Information"
                                    href="{{ route("smtps.edit", base64_encode($smtpConfiguration->id)) }}"
                                >
                                                            ...
                                                            @if ($smtpConfiguration["signature_image"] && file_exists(public_path("images/signature/" . $smtpConfiguration["signature_image"])))
                                                                ...
                                                                >
                                                                    <figure style="margin: 0">
                                                                        <img
                                                                            style="width: 100%"
                                                                            src="{{ asset("images/signature/" . $smtpConfiguration["signature_image"]) }}"
                                                                            alt=""
                                                                        />
                                                                    </figure>
                                                                </td>
