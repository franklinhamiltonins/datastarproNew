            ...
            <div class="card-body p-0 pb-3">
                    ...
                    <div class="row">
                        <div class="col-lg-12 margin-tb d-flex flexwrap-wrap justify-content-between table-top-sec">
                                    ...
                                    <div id="custom_length_menu">
                                        <label class="d-flex align-items-center justify-content-between mb-0">Show
                                            <select id="customPageLength"
                                                ...
                                                aria-controls="contact_status_datatable">
                            ...
                            <div class="d-flex flexwrap-wrap">
                                <div id="contact_status_datatable_filter" class="dataTables_filter search-sec mb-0">
                                    <label
                                        class="d-flex align-items-center justify-content-end mb-0 position-relative"><input
                                            ...
                                            aria-controls="contact_status_datatable" class="form-control">
                                        <i class="fas fa-search position-absolute"></i>
                                    </label>
                                </div>
                                <div class="ml-1">
                                    <a class="btn btn-success btn-sm d-flex align-items-center justify-content-center create-btn" href="{{route('contactstatus.create')}}" style="width: 42px;height: 42px;">
                ...
                <div class="px-3 pt-2">
                    <div class="table-container pb-2">
                        <table class="order-column compact hover searchHighlight contact_status_datatable" id="contact_status_datatable">
                            <thead class="text-nowrap" style="font-size: 0.93rem;">
                                <tr>
                                    <th id="serial_no"></th>
                                    <th></th>
                                    <th>Name <span class="arrow"></span></th>
                                    <th>Priorty <span class="arrow"></span></th>
                                    <th>False Display <span class="arrow"></span></th>
                                    <th>Display in Pipedrive <span class="arrow"></span></th>
                                    <th>
...
jQuery(document).ready(function() {
    ...
    draw_table();
    $('#contact_status_datatable tbody').on('click', 'tr', function() {
                ...
                render: function(data, type, row) {
                    ...
                    return `<div class="d-flex justify-content-center action-btns">
                            ...
                            <form method="get" action="{{url('contactstatus/destroy')}}/`+data+`" accept-charset="UTF-8" style="display:inline" class="leadForm-3"><input name="_method" type="hidden" value="DELETE"><input name="_token" type="hidden" value="{{ csrf_token() }}">
                                ...
                                <a href="#" title="Delete Sms Provider" data-toggle="modal" data-target="#deleteModal" onclick="setModal(this,'3')" class="btn btn-sm btn-danger deletebtn action-btn m-0 d-flex justify-content-center align-items-center">
